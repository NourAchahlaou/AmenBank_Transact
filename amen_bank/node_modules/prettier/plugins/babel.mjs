...
var Bt = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
  si = (a, t) => {
    for (var e in t) Ke(a, e, { get: t[e], enumerable: !0 });
  },
  ii = (a, t, e, s) => {
...
var qe = (a, t, e) => (
  ...
  ii(
    t || !a || !a.__esModule
      ? Ke(e, "default", { value: a, enumerable: !0 })
      : e,
    a,
  )
);
...
`);
  ...
  function ns(a, t, e, s, i, r, n, o, h, l) {
    let c = t,
      ...
      f = i === 16 ? Ne.hex : i === 10 ? Ne.dec : i === 8 ? Ne.oct : Ne.bin,
      d = !1,
      x = 0;
  ...
  function os(a, t, e, s, i, r) {
    ...
    if (n === 123) {
      if (
        (++t,
        ({ code: o, pos: t } = nt(a, t, e, s, a.indexOf("}", t) - t, !0, i, r)),
        ++t,
        o !== null && o > 1114111)
      )
  ...
  var qi = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    ...
    ot = class extends rt {
      ...
      skipBlockComment(t) {
        ...
        for (
          this.state.pos = i + t.length, Ie.lastIndex = s + 2;
          Ie.test(this.input) && Ie.lastIndex <= i;
            ...
            i.forEach((o) => {
              Qi(o)
                ...
                : o.type === "DeclareModuleExports" &&
                  (n && this.raise(g.DuplicateDeclareModuleExports, { at: o }),
                  r === "ES" &&
                    this.raise(g.AmbiguousDeclareModuleKind, { at: o }),
                  (r = "CommonJS"),
                  (n = !0));
          ...
          super.parseClassMember(e, s, i),
            s.declare &&
              ...
              s.type !== "PropertyDefinition"
                ...
                : s.value &&
                  this.raise(g.DeclareClassFieldInitializer, { at: s.value }));
        }
        isIterator(e) {
        ...
        updateContext(e) {
          ...
          if (i === 56 && e === 140)
            ...
            (r === w.j_oTag && e === 56) || r === w.j_cTag
              ? (s.pop(),
                (this.state.canStartJSXElement = s[s.length - 1] === w.j_expr))
              : (this.setContext(w.j_expr),
                (this.state.canStartJSXElement = !0));
    ...
    class extends a {
      ...
      tsParseModifiers(
        ...
        let o = (l, c, u, f) => {
          ...
          h = (l, c, u, f) => {
            ((n[u] && c === f) || (n[f] && c === u)) &&
              this.raise(y.IncompatibleModifiers, { at: l, modifiers: [u, f] });
          };
        for (;;) {
  ...
  var xt = class extends yt {
      ...
      parseExprOp(t, e, s) {
        if (this.isPrivateName(t)) {
          ...
          (s >= ke(58) || !this.prodParam.hasIn || !this.match(58)) &&
      ...
      parseSubscript(t, e, s, i) {
        ...
        if (Oe(r)) return this.parseTaggedTemplateExpression(t, e, i);
        let n = !1;
        if (r === 18) {
          if (
            s &&
      ...
      parseAsyncArrowUnaryFunction(t) {
        this.prodParam.enter(Le(!0, this.prodParam.hasYield));
        let e = [this.parseIdentifier()];
        return (
          this.prodParam.exit(),
          this.hasPrecedingLineBreak() &&
...
`,
      ...
      parseMethod(t, e, s, i, r, n, o = !1) {
        this.initFunction(t, s),
          ...
          this.prodParam.enter(Le(s, t.generator)),
  ...
  var Pt = class extends xt {
      ...
      parseFunction(t, e = 0) {
        ...
        return (
          (this.state.maybeInArrowParameters = !1),
          this.scope.enter(2),
          this.prodParam.enter(Le(n, t.generator)),
...
function la({ isExpression: a = !1, optionsCombinations: t }) {
  return (e, s = {}) => {
    ...
    e.includes("|>")
      ...
      : n && (i = i.map((l) => R([_s], l)));
    let o = a ? ze.parseExpression : ze.parse,
      h;
    try {
    ...
    return (
      a && (h = Ve(h, { text: e, rootMarker: s.rootMarker })),
...
var da = { ...Hs, ...Gs };
var Kn = Ft;
export { Kn as default, da as parsers };
