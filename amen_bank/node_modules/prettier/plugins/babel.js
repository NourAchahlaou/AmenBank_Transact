(function (f) {
  ...
  var Ft = (a, t) => () => (
    ...
    si = (a, t) => {
      for (var e in t) Ie(a, e, { get: t[e], enumerable: !0 });
    },
    Bt = (a, t, e, s) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of Zs(t))
          !ti.call(a, i) &&
            ...
            Ie(a, i, {
              get: () => t[i],
              enumerable: !(s = Qs(t, i)) || s.enumerable,
            });
      return a;
    };
  var qe = (a, t, e) => (
      ...
      Bt(
        t || !a || !a.__esModule
          ? Ie(e, "default", { value: a, enumerable: !0 })
          : e,
        a,
      )
    ),
    ii = (a) => Bt(Ie({}, "__esModule", { value: !0 }), a);
  var kt = Ft((be) => {
    "use strict";
    ...
    var Ye = {
        ...
        Object.keys(e)
          ...
          .map(([s, i]) => [
            ...
            typeof i == "function"
              ...
              ? Object.assign({}, i, ri(i.reflect.split(".")))
              : i,
          ])
          .reduce(
            (s, [i, r]) =>
      ...
      Qe = ({ type: a, prefix: t }) =>
        a === "UpdateExpression" ? Rt.UpdateExpression[String(t)] : Rt[a],
      oi = {
        AccessorIsGenerator: ({ kind: a }) =>
...
- Did you mean \`import { "${a}" as foo }\`?`,
        ...
        InvalidIdentifier: ({ identifierName: a }) =>
          `Invalid identifier ${a}.`,
        InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Qe(a)}.`,
        InvalidLhsBinding: ({ ancestor: a }) =>
          `Binding invalid left-hand side in ${Qe(a)}.`,
    ...
    function di(a) {
      ...
      return function s({ loc: i, details: r }) {
        return ai(SyntaxError, Object.assign({}, e, { loc: i }), {
          clone(n = {}) {
            let o = n.loc || {};
            return s({
              loc: new F(
    ...
    function $(a, t) {
      ...
      for (let s of Object.keys(a)) {
        ...
        e[s] = di(
          Object.assign(
            { code: Ye.SyntaxError, reasonCode: s, toMessage: h },
            t ? { syntaxPlugin: t } : {},
            o,
          ),
        );
    ...
    var p = Object.assign({}, $(ni), $(oi), $(hi), $`pipelineOperator`(ci)),
      { defineProperty: fi } = Object,
      _t = (a, t) => fi(a, t, { enumerable: !1, value: a[t] });
    function pe(a) {
      return (
        a.loc.start && _t(a.loc.start, "index"),
        a.loc.end && _t(a.loc.end, "index"),
        a
      );
    }
    var mi = (a) =>
    ...
    function P(a, t = {}) {
      ...
      return (
        ++ye,
        Tt.push(a),
        bt.push((e = t.binop) != null ? e : -1),
        At.push((s = t.beforeExpr) != null ? s : !1),
        St.push((i = t.startsExpr) != null ? i : !1),
        wt.push((r = t.prefix) != null ? r : !1),
        U.push(new Oe(a, t)),
        ye
      );
    }
    ...
    var xi = {
      ...
      eq: P("=", { beforeExpr: T, isAssign: ue }),
      assign: P("_=", { beforeExpr: T, isAssign: ue }),
      slashAssign: P("_=", { beforeExpr: T, isAssign: ue }),
      xorAssign: P("_=", { beforeExpr: T, isAssign: ue }),
      moduloAssign: P("_=", { beforeExpr: T, isAssign: ue }),
      incDec: P("++/--", { prefix: z, postfix: yi, startsExpr: m }),
      bang: P("!", { beforeExpr: T, prefix: z, startsExpr: m }),
      tilde: P("~", { beforeExpr: T, prefix: z, startsExpr: m }),
      ...
      bitShiftL: v("<</>>/>>>", 8),
      bitShiftR: v("<</>>/>>>", 8),
      plusMin: P("+/-", { beforeExpr: T, binop: 9, prefix: z, startsExpr: m }),
      modulo: P("%", { binop: 10, startsExpr: m }),
      star: P("*", { binop: 10 }),
      slash: v("/", 10),
      exponent: P("**", { beforeExpr: T, binop: 11, rightAssociative: !0 }),
      _in: A("in", { beforeExpr: T, binop: 7 }),
      _instanceof: A("instanceof", { beforeExpr: T, binop: 7 }),
      _break: A("break"),
      _case: A("case", { beforeExpr: T }),
      _catch: A("catch"),
      _continue: A("continue"),
      _debugger: A("debugger"),
      _default: A("default", { beforeExpr: T }),
      _else: A("else", { beforeExpr: T }),
      _finally: A("finally"),
      _function: A("function", { startsExpr: m }),
      _if: A("if"),
      _return: A("return", { beforeExpr: T }),
      _switch: A("switch"),
      _throw: A("throw", { beforeExpr: T, prefix: z, startsExpr: m }),
      _try: A("try"),
      _var: A("var"),
      _const: A("const"),
      _with: A("with"),
      _new: A("new", { beforeExpr: T, startsExpr: m }),
      _this: A("this", { startsExpr: m }),
      _super: A("super", { startsExpr: m }),
      _class: A("class", { startsExpr: m }),
      _extends: A("extends", { beforeExpr: T }),
      _export: A("export"),
      _import: A("import", { startsExpr: m }),
      _null: A("null", { startsExpr: m }),
      _true: A("true", { startsExpr: m }),
      _false: A("false", { startsExpr: m }),
      _typeof: A("typeof", { beforeExpr: T, prefix: z, startsExpr: m }),
      _void: A("void", { beforeExpr: T, prefix: z, startsExpr: m }),
      _delete: A("delete", { beforeExpr: T, prefix: z, startsExpr: m }),
      _do: A("do", { isLoop: He, beforeExpr: T }),
      _for: A("for", { isLoop: He }),
      _while: A("while", { isLoop: He }),
    ...
    var Zt = [
        ...
        2, 4, 2, 16, 4421, 42719, 33, 4153, 7, 221, 3, 5761, 15, 7472, 3104,
    ...
    function j(a) {
      return a < 65
        ...
        ? !0
        : a <= 65535
        ? a >= 170 && Ni.test(String.fromCharCode(a))
        : et(a, Zt);
    }
    function ee(a) {
      return a < 48
        ...
        ? !0
        : a <= 65535
        ? a >= 170 && ki.test(String.fromCharCode(a))
        : et(a, Zt) || et(a, vi);
    }
    var It = {
        keyword: [
      ...
      Li = new Set(It.keyword),
      Di = new Set(It.strict),
      Mi = new Set(It.strictBind);
    function es(a, t) {
        ...
        declareName(t, e, s) {
          ...
          if (e & 8 || e & 16)
            this.checkRedeclarationInScope(i, t, e, s),
              e & 16 ? i.functions.add(t) : i.lexical.add(t),
        ...
        isRedeclaredInScope(t, e, s) {
          return s & 1
            ? s & 8
              ...
              : (t.lexical.has(e) &&
                  !(t.flags & 8 && t.lexical.values().next().value === e)) ||
    ...
    var rt = class extends it {
        ...
        finalizeComment(t) {
          ...
          if (t.leadingNode !== null || t.trailingNode !== null)
            t.leadingNode !== null && rs(t.leadingNode, e),
              t.trailingNode !== null && _i(t.trailingNode, e);
          else {
    ...
    var at = class a {
        ...
        init({ strictMode: t, sourceType: e, startLine: s, startColumn: i }) {
          (this.strict = t === !1 ? !1 : t === !0 ? !0 : e === "module"),
            (this.curLine = s),
            (this.lineStart = -i),
            (this.startLoc = this.endLoc = new F(s, i, 0));
        }
        curPosition() {
...
`);
        ...
        case 120: {
          let l;
          return (
            ({ code: l, pos: t } = nt(a, t, e, s, 2, !1, n, r)),
    ...
    function nt(a, t, e, s, i, r, n, o) {
      let h = t,
        l;
      return (
        ({ n: l, pos: t } = ns(a, t, e, s, 16, i, r, !1, o, !n)),
    ...
    function ns(a, t, e, s, i, r, n, o, h, l) {
      let c = t,
        u = i === 16 ? $t.hex : $t.decBinOct,
        f = i === 16 ? ke.hex : i === 10 ? ke.dec : i === 8 ? ke.oct : ke.bin,
        d = !1,
        x = 0;
    ...
    function os(a, t, e, s, i, r) {
      ...
      } else ({ code: o, pos: t } = nt(a, t, e, s, 4, !1, i, r));
      return { code: o, pos: t };
    }
    var zi = ["at"],
      Ki = ["at"];
    ...
    var qi = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
      O = class {
        constructor(t) {
          (this.type = t.type),
            (this.value = t.value),
            (this.start = t.start),
            (this.end = t.end),
            (this.loc = new ie(t.startLoc, t.endLoc));
        }
      },
      ot = class extends rt {
        constructor(t, e) {
            ...
            (this.errorHandlers_readInt = {
              invalidDigit: (s, i, r, n) =>
                this.options.errorRecovery
                  ? (this.raise(p.InvalidDigit, { at: fe(s, i, r), radix: n }),
                    !0)
                  : !1,
        ...
        nextTokenInLineStartSince(t) {
          return (Le.lastIndex = t), Le.test(this.input) ? Le.lastIndex : t;
        }
        ...
        skipBlockComment(t) {
          ...
          for (
            this.state.pos = i + t.length, Ne.lastIndex = s + 2;
            Ne.test(this.input) && Ne.lastIndex <= i;

          )
            ++this.state.curLine, (this.state.lineStart = Ne.lastIndex);
          ...
          let r = {
            ...
            loc: new ie(e, this.state.curPosition()),
          };
        ...
        skipLineComment(t) {
          ...
          let r = this.state.pos,
            o = {
              ...
              loc: new ie(s, this.state.curPosition()),
            };
        ...
        readRegexp() {
          ...
          for (; ; ++r) {
            ...
            if (xe(l)) throw this.raise(p.UnterminatedRegExp, { at: L(t, 1) });
            if (s) s = !1;
            else {
              if (l === 91) i = !0;
              else if (l === 93 && i) i = !1;
            ...
            if (qi.has(l))
              l === 118
                ...
                : l === 117 &&
                  ...
                  this.raise(p.IncompatibleRegExpUVFlags, { at: h() }),
                o.includes(c) &&
                  this.raise(p.DuplicateRegExpFlags, { at: h() });
            else if (ee(l) || l === 92)
        ...
        readNumber(t) {
          ...
          if (
            ...
            c === 109 &&
              ...
              ++this.state.pos,
              (n = !0)),
            j(this.codePointAtPos(this.state.pos)))
          )
            throw this.raise(p.NumberIdentifier, {
              at: this.state.curPosition(),
            });
        ...
        readTemplateToken() {
          ...
          (this.state.pos = i + 1),
            ...
            s &&
              (this.state.firstInvalidTemplateEscapePos = new F(
                s.curLine,
                s.pos - s.lineStart,
                s.pos,
              )),
            this.input.codePointAt(i) === 96
              ...
              : (this.state.pos++,
                this.finishToken(25, s ? null : t + e + "${"));
        }
        ...
        raise(t, e) {
          let { at: s } = e,
            i = Me(e, zi),
            r = s instanceof F ? s : s.loc.start,
            n = t({ loc: r, details: i });
    ...
    var ut = class extends ot {
        ...
        initializeScopes(t = this.options.sourceType === "module") {
          ...
          return (
            (this.expressionScope = new ct(this)),
            () => {
              (this.state.labels = e),
      ...
      Nt = ae.prototype;
    Nt.__clone = function () {
      let a = new ae(void 0, this.start, this.loc.start),
        t = Object.keys(this);
        ...
        class extends a {
          ...
          flowParsePredicate() {
            ...
            return (
              ...
              this.state.lastTokStart > s.index + 1 &&
                this.raise(g.UnexpectedSpaceBetweenModuloChecks, { at: s }),
              this.eat(10)
          ...
          flowParseDeclare(e, s) {
            ...
            if (this.eatContextual(125))
              return this.match(16)
                ...
                : (s &&
                    this.raise(g.NestedDeclareModule, {
          ...
          flowParseDeclareModule(e) {
              ...
              this.match(83)
                ? (this.next(),
                  !this.isContextual(128) &&
                    !this.match(87) &&
                    this.raise(g.InvalidNonTypeImportInDeclareModule, {
                      at: this.state.lastTokStartLoc,
                    }),
                  super.parseImport(o))
            ...
            return (
              i.forEach((o) => {
                Qi(o)
                  ? (r === "CommonJS" &&
                      this.raise(g.AmbiguousDeclareModuleKind, { at: o }),
                    (r = "ES"))
                  : o.type === "DeclareModuleExports" &&
                    (n &&
                      this.raise(g.DuplicateDeclareModuleExports, { at: o }),
                    r === "ES" &&
                      this.raise(g.AmbiguousDeclareModuleKind, { at: o }),
                    (r = "CommonJS"),
                    (n = !0));
          ...
          flowParseDeclareExportDeclaration(e, s) {
            ...
            if (
              ...
              throw this.raise(g.UnsupportedDeclareExportKind, {
                at: this.state.startLoc,
          ...
          flowParseInterfaceish(e, s) {
            ...
            if (s) {
              if (
                ((e.implements = []), (e.mixins = []), this.eatContextual(115))
              )
          ...
          checkNotUnderscore(e) {
            e === "_" &&
              this.raise(g.UnexpectedReservedUnderscore, {
                at: this.state.startLoc,
              });
          }
          checkReservedType(e, s, i) {
            Yi.has(e) &&
              this.raise(i ? g.AssignReservedType : g.UnexpectedReservedType, {
                at: s,
                reservedType: e,
              });
          }
          ...
          flowParseTypeParameter(e = !1) {
            ...
            return (
              ...
              this.match(29)
                ...
                : e && this.raise(g.MissingTypeParamDefault, { at: s }),
          ...
          flowParseObjectType({
            ...
            for (
              ...
              if (e && this.isContextual(104)) {
                let N = this.lookahead();
                N.type !== 14 && N.type !== 17 && (this.next(), (d = !0));
              }
              let E = this.flowParseVariance();
              if (this.eat(0))
                x != null && this.unexpected(x),
                  this.eat(0)
                    ? (E && this.unexpected(E.loc.start),
                      h.internalSlots.push(
                        this.flowParseObjectTypeInternalSlot(C, d),
                      ))
                    : h.indexers.push(this.flowParseObjectTypeIndexer(C, d, E));
              else if (this.match(10) || this.match(47))
                x != null && this.unexpected(x),
                  E && this.unexpected(E.loc.start),
                  h.callProperties.push(
                    this.flowParseObjectTypeCallProperty(C, d),
                  );
              else {
                let N = "init";
                ...
                let Ee = this.flowParseObjectTypeProperty(
                  C,
                  d,
                  x,
                  E,
                ...
                Ee === null
                  ...
                  : h.properties.push(Ee);
              }
              this.flowObjectTypeSemicolon(),
                I &&
                  !this.match(8) &&
                  !this.match(9) &&
                  this.raise(g.UnexpectedExplicitInexactInObject, { at: I });
            }
          ...
          flowParseObjectTypeProperty(e, s, i, r, n, o, h) {
            if (this.eat(21))
              return this.match(12) ||
                ...
                ? (o
                    ? h ||
                      this.raise(g.InexactInsideExact, {
                        at: this.state.lastTokStartLoc,
                      })
                    : this.raise(g.InexactInsideNonObject, {
                        at: this.state.lastTokStartLoc,
                      }),
                  r && this.raise(g.InexactVariance, { at: r }),
                  null)
                : (o ||
                    this.raise(g.UnexpectedSpreadType, {
                      at: this.state.lastTokStartLoc,
                    }),
                  i != null && this.unexpected(i),
                  r && this.raise(g.SpreadVariance, { at: r }),
                ...
                this.match(47) || this.match(10)
                  ? ((e.method = !0),
                    ...
                    !o &&
                      ...
                      e.value.this &&
                      this.raise(g.ThisParamBannedInConstructor, {
                        at: e.value.this,
                      }))
          ...
          flowParseFunctionTypeParam(e) {
            ...
            return (
              o.type === 14 || o.type === 17
                ? (h && !e && this.raise(g.ThisParamMustBeFirst, { at: n }),
                  (s = this.parseIdentifier(h)),
                  this.eat(17) &&
                    ((i = !0),
                    h && this.raise(g.ThisParamMayNotBeOptional, { at: n })),
            ...
            switch (this.state.type) {
              ...
              case 53:
                if (this.state.value === "-") {
                  ...
                  throw this.raise(g.UnexpectedSubtractionOperand, {
                    at: this.state.startLoc,
                  });
                }
                this.unexpected();
          ...
          shouldParseExportDeclaration() {
            ...
            return Ut(e) || (this.shouldParseEnums() && e === 124)
              ? !this.state.containsEsc
          ...
          parseConditional(e, s, i) {
            ...
            if (l || u.length > 0) {
              ...
              l &&
                c.length > 1 &&
                this.raise(g.AmbiguousConditionalArrow, { at: r.startLoc }),
                l &&
                  c.length === 1 &&
                  ((this.state = r),
                  f.push(c[0].start),
          ...
          getArrowLikeExpressions(e, s) {
            ...
            return s
              ...
              : er(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
          }
          ...
          parseClassMember(e, s, i) {
            ...
            super.parseClassMember(e, s, i),
              s.declare &&
                ...
                s.type !== "PropertyDefinition"
                  ? this.raise(g.DeclareClassElement, { at: r })
                  : s.value &&
          ...
          getTokenFromCode(e) {
            ...
            e === 123 && s === 124
              ...
              ? s === 46
                ? this.finishOp(18, 2)
                : this.finishOp(17, 1)
              : Fi(e, s, this.input.charCodeAt(this.state.pos + 2))
          ...
          toReferencedList(e, s) {
            for (let r = 0; r < e.length; r++) {
              ...
              n &&
                ...
                (e.length > 1 || !s) &&
                this.raise(g.TypeCastInPattern, { at: n.typeAnnotation });
            }
            return e;
          }
          ...
          pushClassMethod(e, s, i, r, n, o) {
            if (
              ...
              h.length > 0 &&
                ...
                this.raise(g.ThisParamBannedInConstructor, { at: s });
          ...
          checkGetterSetterParams(e) {
            ...
            if (s.length > 0) {
              ...
              this.isThisParam(i) && e.kind === "get"
                ? this.raise(g.GetterMayNotHaveThisParam, { at: i })
                : this.isThisParam(i) &&
                  this.raise(g.SetterMayNotHaveThisParam, { at: i });
            }
          }
          ...
          parseAssignableListItemTypes(e) {
            return (
              this.eat(17) &&
                (e.type !== "Identifier" &&
                  this.raise(g.PatternIsOptional, { at: e }),
                this.isThisParam(e) &&
                  this.raise(g.ThisParamMayNotBeOptional, { at: e }),
                (e.optional = !0)),
              this.match(14)
                ? (e.typeAnnotation = this.flowParseTypeAnnotation())
                : this.isThisParam(e) &&
                  this.raise(g.ThisParamAnnotationRequired, { at: e }),
              this.match(29) &&
                this.isThisParam(e) &&
                this.raise(g.ThisParamNoDefault, { at: e }),
          ...
          parseMaybeDefault(e, s) {
            ...
            return (
              i.type === "AssignmentPattern" &&
                ...
                this.raise(g.TypeBeforeInitializer, { at: i.typeAnnotation }),
              i
            );
          }
          checkImportReflection(e) {
            super.checkImportReflection(e),
              e.module &&
                e.importKind !== "value" &&
                this.raise(g.ImportReflectionHasImportType, {
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
              ...
              h !== null && !M(this.state.type)
                ? ((e.imported = u), (e.importKind = h), (e.local = V(u)))
                : ((e.imported = o),
                  (e.importKind = null),
              ...
              this.eatContextual(93)
                ? (e.local = this.parseIdentifier())
                : ((l = !0), (e.local = V(e.imported)));
            }
            let c = zt(e);
            return (
              i &&
                c &&
                this.raise(g.ImportTypeShorthandOnlyInPureImport, { at: e }),
              (i || c) &&
            ...
            if (((i = n) != null && i.error) || this.match(47)) {
              ...
              let l,
                c = this.tryParse((f) => {
                  ...
                  return (
                    I.type !== "ArrowFunctionExpression" && f(),
                    (I.typeParameters = l),
              ...
              throw (h = n) != null && h.thrown
                ...
                : c.thrown
                ? c.error
                : this.raise(g.UnexpectedTokenAfterTypeParameter, { at: l });
            }
            ...
            if (
              ...
              for (let n = 0; n < e.params.length; n++)
                this.isThisParam(e.params[n]) &&
                  n > 0 &&
                  this.raise(g.ThisParamMustBeFirst, { at: e.params[n] });
          ...
          parseTopLevel(e, s) {
            ...
            return (
              this.state.hasFlowComment &&
                this.raise(g.UnterminatedFlowComment, {
                  at: this.state.curPosition(),
                }),
              i
            );
          ...
          skipBlockComment() {
            if (this.hasPlugin("flowComments") && this.skipFlowComment()) {
              if (this.state.hasFlowComment)
                throw this.raise(g.NestedFlowComment, {
                  at: this.state.startLoc,
                });
          ...
          flowEnumErrorBooleanMemberNotInitialized(
            ...
            this.raise(g.EnumBooleanMemberNotInitialized, {
              at: e,
              memberName: i,
              enumName: s,
            });
          ...
          flowEnumErrorNumberMemberNotInitialized(
            ...
            this.raise(g.EnumNumberMemberNotInitialized, {
              at: e,
              enumName: s,
              memberName: i,
            });
          ...
          flowEnumErrorStringMemberInconsistentlyInitailized(
            ...
            this.raise(g.EnumStringMemberInconsistentlyInitailized, {
              at: e,
              enumName: s,
            });
          }
          ...
          flowEnumMembers({ enumName: e, explicitType: s }) {
            ...
            for (; !this.match(8); ) {
              ...
              if (c === "") continue;
              /^[a-z]/.test(c) &&
                this.raise(g.EnumInvalidMemberName, {
                  at: h,
                  memberName: c,
                ...
                i.has(c) &&
                  this.raise(g.EnumDuplicateMemberName, {
                    at: h,
                    memberName: c,
                    enumName: e,
                  }),
          ...
          flowEnumParseExplicitType({ enumName: e }) {
            ...
            if (!S(this.state.type))
              throw this.raise(g.EnumInvalidExplicitTypeUnknownSupplied, {
                at: this.state.startLoc,
                enumName: e,
              });
            ...
            return (
              ...
              s !== "boolean" &&
                ...
                s !== "string" &&
                s !== "symbol" &&
                this.raise(g.EnumInvalidExplicitType, {
                  at: this.state.startLoc,
                  enumName: e,
                  invalidEnumType: s,
                }),
            ...
            switch (((e.hasUnknownMembers = h), n)) {
              ...
              default: {
                ...
                if (!u && !f && c >= d) {
                  ...
                  return (
                    this.raise(g.EnumInconsistentMemberValues, {
                      at: r,
                      enumName: i,
                    }),
                    l()
    ...
    var ir = (a) =>
        class extends a {
          jsxReadToken() {
            ...
            for (;;) {
              if (this.state.pos >= this.length)
                throw this.raise(W.UnterminatedJsxContent, {
                  at: this.state.startLoc,
                });
...
`))
            ...
            switch (this.state.type) {
              case 5:
                return (
                  ...
                  this.next(),
                  (e = this.jsxParseExpressionContainer(e, w.j_oTag)),
                  e.expression.type === "JSXEmptyExpression" &&
                    this.raise(W.AttributeIsEmpty, { at: e }),
                  e
                );
              case 140:
              case 131:
          ...
          jsxParseElementAt(e) {
            ...
            if (!r.selfClosing) {
                  ...
                  case 5: {
                    ...
                    this.setContext(w.brace),
                      ...
                      this.match(21)
                        ...
                        : i.push(this.jsxParseExpressionContainer(o, w.j_expr));
                    break;
                  }
                  default:
                    this.unexpected();
              ...
              K(r) && !K(n) && n !== null
                ? this.raise(W.MissingClosingTagFragment, { at: n })
                : !K(r) && K(n)
                ? this.raise(W.MissingClosingTagElement, {
                    at: n,
                    openingTagName: Z(r.name),
                  })
                : !K(r) &&
                  !K(n) &&
                  Z(n.name) !== Z(r.name) &&
            ...
            if (
              ...
              throw this.raise(W.UnwrappedAdjacentJSXElements, {
                at: this.state.startLoc,
              });
            return K(r)
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 140)
              s.splice(-2, 2, w.j_cTag), (this.state.canStartJSXElement = !1);
            else if (i === 140) s.push(w.j_oTag);
            else if (i === 141) {
              let r = s[s.length - 1];
              (r === w.j_oTag && e === 56) || r === w.j_cTag
                ? (s.pop(),
                  (this.state.canStartJSXElement =
                    s[s.length - 1] === w.j_expr))
                : (this.setContext(w.j_expr),
                  (this.state.canStartJSXElement = !0));
            } else this.state.canStartJSXElement = gi(i);
          }
        },
      ft = class extends Pe {
        constructor(...t) {
      ...
      mt = class extends ge {
        ...
        createScope(t) {
          return this.importsStack.push(new Set()), new ft(t);
        }
        enter(t) {
        ...
        declareName(t, e, s) {
          ...
          super.declareName(t, e, s),
            e & 2 &&
              ...
              i.types.add(t)),
            e & 256 && i.enums.add(t),
            e & 512 && i.constEnums.add(t),
            e & 128 && i.classes.add(t);
        }
        isRedeclaredInScope(t, e, s) {
          if (t.enums.has(e)) {
            if (s & 256) {
      ...
      rr = (a, t) => Object.hasOwnProperty.call(a, t) && a[t],
      ps = (a) => (a.type === "ParenthesizedExpression" ? ps(a.expression) : a),
      yt = class extends dt {
        toAssignable(t, e = !1) {
          var s, i;
          let r;
        ...
        checkIdentifier(t, e, s = !1) {
          this.state.strict &&
            (s ? is(t.name, this.inModule) : ss(t.name)) &&
            (e === 64
      ...
      class extends a {
        ...
        tsParseModifiers(
          ...
          let o = (l, c, u, f) => {
            ...
            h = (l, c, u, f) => {
              ((n[u] && c === f) || (n[f] && c === u)) &&
                this.raise(y.IncompatibleModifiers, {
                  at: l,
                  modifiers: [u, f],
                });
            };
        ...
        tsParseDelimitedList(e, s, i) {
          return nr(this.tsParseDelimitedListWorker(e, s, !0, i));
        }
        ...
        tsParseTypeParameters(e) {
          ...
          return (
            ...
            s.params.length === 0 &&
              this.raise(y.EmptyTypeParameters, { at: s }),
        ...
        tsParseBindingListForSignature() {
          ...
          for (let s of e) {
            ...
            (i === "AssignmentPattern" || i === "TSParameterProperty") &&
              this.raise(y.UnsupportedSignatureParameterKind, {
                at: s,
                type: i,
              });
          }
        ...
        tsParsePropertyOrMethodSignature(e, s) {
          ...
          if (this.match(10) || this.match(47)) {
            ...
            if (r.kind === "get")
              ...
              r[o] &&
                this.raise(y.SetAccesorCannotHaveReturnType, { at: r[o] });
            } else r.kind = "method";
        ...
        tsParseTypeOperatorOrHigher() {
          return Ci(this.state.type) && !this.state.containsEsc
        ...
        tsParseInterfaceDeclaration(e, s = {}) {
          ...
          this.expectContextual(127),
            ...
            S(this.state.type)
              ...
              : ((e.id = null),
                this.raise(y.MissingInterfaceName, {
                  at: this.state.startLoc,
                })),
            ...
            let o,
              h = this.tsTryParseAndCatch(() => {
                ...
                if (
                  c === 48 ||
                  c === 52 ||
                  (c !== 10 && Ze(c) && !this.hasPrecedingLineBreak())
                )
                  return;
        ...
        parseExprOp(e, s, i) {
          ...
          if (
            ...
            return (
              ...
              this.finishNode(
                n,
                r ? "TSSatisfiesExpression" : "TSAsExpression",
              ),
              this.reScan_lt_gt(),
        ...
        parseStatementContent(e, s) {
          if (this.match(75) && this.isLookaheadContextual("enum")) {
            let i = this.startNode();
            return (
              this.expect(75), this.tsParseEnumDeclaration(i, { const: !0 })
            );
          }
        ...
        parseClassMemberWithIsStatic(e, s, i, r) {
          ...
          !this.state.inAbstractClass &&
            ...
            s.override &&
              (i.hadSuperClass ||
                this.raise(y.OverrideNotInSubClass, { at: s })),
            ...
            d = this.tryParse((x) => {
              ...
              return (
                (E.type !== "ArrowFunctionExpression" ||
                  ...
                  x(),
                ((C = f) == null ? void 0 : C.params.length) !== 0 &&
                  this.resetStartLocationFromNode(E, f),
                (E.typeParameters = f),
                E
              );
            }, l);
        ...
        parseExportSpecifier(e, s, i, r) {
          return !s && r
            ...
            : ((e.exportKind = "value"),
              super.parseExportSpecifier(e, s, i, r));
        }
        parseImportSpecifier(e, s, i, r, n) {
          return !s && r
        ...
        class extends a {
          ...
          parseClass(e, s, i) {
            ...
            if (o)
              if (this.match(81) || this.match(142) || this.match(5)) e.id = o;
                ...
                throw this.raise(Ht.ClassNameIsRequired, {
                  at: this.state.startLoc,
                });
              }
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              ...
              if (
                ...
                this.input.startsWith(q(142), this.nextTokenStartSince(e + 4))
              )
                return !0;
            }
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index &&
              this.raise(Ht.UnexpectedSpace, { at: this.state.lastTokEndLoc });
          }
        },
      fr = (a) =>
        class extends a {
    ...
    var Wt = ["minimal", "fsharp", "hack", "smart"],
      Jt = ["^^", "@@", "^", "%", "#"],
      Xt = ["hash", "bar"];
    function mr(a) {
      if (k(a, "decorators")) {
      ...
      if (
        k(a, "recordAndTuple") &&
        J(a, "recordAndTuple", "syntaxType") != null &&
        !Xt.includes(J(a, "recordAndTuple", "syntaxType"))
      )
        throw new Error(
    ...
    function xr(a) {
      if (a == null) return Object.assign({}, Je);
    ...
    var xt = class extends yt {
        ...
        parseSubscript(t, e, s, i) {
          ...
          if (Fe(r)) return this.parseTaggedTemplateExpression(t, e, i);
          let n = !1;
          if (r === 18) {
            if (
              s &&
        ...
        parseMember(t, e, s, i, r) {
          ...
          return (
            ...
            i
              ...
              : this.match(136)
              ? (t.type === "Super" &&
                  this.raise(p.SuperPrivateField, { at: e }),
                this.classScope.usePrivateName(
                  this.state.value,
                  this.state.startLoc,
                ),
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, i) {
          ...
          h && (this.expressionScope.enter(Ji()), (n = new se())),
            l && (o.optional = i),
            i
        ...
        parseAsyncArrowFromCallExpression(t, e) {
          ...
          return (
            ...
            e.innerComments && Te(t, e.innerComments),
            e.callee.trailingComments && Te(t, e.callee.trailingComments),
            t
          );
        }
        parseNoCallExpr() {
        ...
        parseImportMetaProperty(t) {
          ...
          return (
            ...
            this.isContextual(100) &&
              (this.inModule ||
                this.raise(p.ImportMetaOutsideModule, { at: e }),
              (this.sawUnambiguousESM = !0)),
        ...
        parseParenAndDistinguishExpression(t) {
          ...
          for (; !this.match(11); ) {
            if (l) l = !1;
              ...
              (this.expect(
                12,
                h.optionalParametersLoc === null
                  ? null
                  : h.optionalParametersLoc,
              ),
              this.match(11))
            ) {
...
`,
        ...
        parseObjectProperty(t, e, s, i) {
          ...
          if (!t.computed && t.key.type === "Identifier") {
            if (
              (this.checkReservedWord(t.key.name, t.key.loc.start, !0, !1), s)
            )
        ...
        parseMethod(t, e, s, i, r, n, o = !1) {
          this.initFunction(t, s),
            ...
            this.prodParam.enter(De(s, t.generator)),
        ...
        parseArrowExpression(t, e, s, i) {
          this.scope.enter(6);
          let r = De(s, !1);
          !this.match(5) && this.prodParam.hasIn && (r |= Q),
        ...
        parseFunctionBody(t, e, s = !1) {
          ...
          if ((this.expressionScope.enter(hs()), i))
            ...
            let r = this.state.strict,
              n = this.state.labels;
            (this.state.labels = []),
              this.prodParam.enter(this.prodParam.currentFlags() | cs),
              (t.body = this.parseBlock(!0, !1, (o) => {
                ...
                this.checkParams(t, !this.state.strict && !e && !s && !h, e, l),
                  this.state.strict &&
                    t.id &&
                    this.checkIdentifier(t.id, 65, l);
              })),
              this.prodParam.exit(),
              (this.state.labels = n);
          }
        ...
        parseIdentifierName(t) {
          ...
          return (
            t
              ? r && this.replaceToken(130)
              : this.checkReservedWord(e, s, r, !1),
            this.next(),
            e
          );
        }
        checkReservedWord(t, e, s, i) {
          if (t.length > 10 || !Ri(t)) return;
          if (s && Oi(t)) {
    ...
    var Pt = class extends xt {
        parseTopLevel(t, e) {
          return (
            ...
            (t.comments = this.state.comments),
            this.options.tokens && (t.tokens = Tr(this.tokens, this.input)),
        ...
        hasFollowingBindingAtom() {
          let t = this.nextTokenStart(),
            e = this.codePointAtPos(t);
          return (
            this.chStartsBindingPattern(e) ||
            this.chStartsBindingIdentifier(e, t)
          );
        }
          ...
          let s = this.isContextual(99);
          {
            ...
            if (this.match(74) || this.match(75) || c) {
              ...
              let d = this.finishNode(u, "VariableDeclaration"),
                x = this.match(58);
              return (
                x && l && this.raise(p.ForInUsing, { at: d }),
                (x || this.isContextual(101)) && d.declarations.length === 1
        ...
        parseCatchClauseParam() {
          ...
          return (
            this.scope.enter(
              this.options.annexB && t.type === "Identifier" ? 8 : 0,
            ),
            this.checkLVal(t, { in: { type: "CatchClause" }, binding: 9 }),
            t
          );
        }
        parseTryStatement(t) {
        ...
        parseFunction(t, e = 0) {
          ...
          return (
            (this.state.maybeInArrowParameters = !1),
            this.scope.enter(2),
            this.prodParam.enter(De(n, t.generator)),
        ...
        parseClassMemberWithIsStatic(t, e, s, i) {
          ...
          let f = S(this.state.type) && !this.state.containsEsc,
            d = this.match(136),
          ...
          if ((this.parsePostMemberNameModifiers(u), this.isClassMethod())) {
            ...
            C &&
              ...
              (s.hadConstructor = !0),
              (E = s.hadSuperClass)),
              this.pushClassMethod(t, r, !1, !1, C, E);
          } else if (this.isClassProperty())
            d
        ...
        parseExport(t, e) {
          ...
          if (l || c || u) {
            ...
            if (
              ...
              ((f = d.declaration) == null ? void 0 : f.type) ===
                "ClassDeclaration")
            )
            ...
            if (s) {
              if (
                ...
                o.type === "Identifier" &&
                  ...
                  this.raise(p.ExportDefaultFromAsIdentifier, { at: o });
              }
        ...
        parseExportSpecifier(t, e, s, i) {
          return (
            this.eatContextual(93)
              ...
              : e
              ? (t.exported = Gi(t.local))
              : t.exported || (t.exported = V(t.local)),
        ...
        parseMaybeImportPhase(t, e) {
          ...
          let s = this.parseIdentifier(!0),
            { type: i } = this.state;
          return (
            M(i) ? i !== 97 || this.lookaheadCharCode() === 102 : i !== 12
          )
      ...
      Re = class extends Pt {
        constructor(t, e) {
          (t = xr(t)),
            ...
            (this.plugins = br(this.options.plugins)),
    ...
    function me(a, t) {
      let e = Re;
      return (
        a != null && a.plugins && (mr(a.plugins), (e = Er(a.plugins))),
        new e(a, t)
      );
    }
    var Gt = {};
    function Er(a) {
      let t = yr.filter((i) => k(a, i)),
        e = t.join("/"),
        s = Gt[e];
      if (!s) {
        s = Re;
        for (let i of t) s = fs[i](s);
        Gt[e] = s;
      }
      return s;
    }
...
`;
      ...
      let e = "";
      for (; e !== a; ) (e = a), (a = a.replace(Br, `${t}$1 $2${t}`));
      a = a.replace(As, "").trimRight();
      let s = Object.create(null),
        i = a.replace(Ss, "").replace(As, "").trimRight(),
        r;
      for (; (r = Ss.exec(a)); ) {
        let n = r[2].replace(Fr, "");
        typeof s[r[1]] == "string" || Array.isArray(s[r[1]])
          ? (s[r[1]] = Es.concat(s[r[1]], n))
          : (s[r[1]] = n);
      }
...
` ||
  ...
  function Vr(a) {
    ...
    let e = (0, ne.extract)(a),
      { pragmas: s, comments: i } = (0, ne.parseWithComments)(e);
  ...
  function Kr(a) {
    return (
      ...
      { astFormat: "estree", hasPragma: ks, locStart: D, locEnd: B, ...a }
    );
  }
  var oe = Kr;
  function qr(a, t) {
  ...
  var vs = Jr;
  var Xr = vs(["Block", "CommentBlock", "MultiLine"]),
    Se = Xr;
  function Gr(a) {
...
`);
  ...
  function Ce(a) {
    ...
    return (we = Ce.prototype = a ?? Object.create(null)), new Ce();
  }
  var Qr = 10;
  for (let a = 0; a <= Qr; a++) Ce();
  function Dt(a) {
    return Ce(a);
  }
  ...
  function Mt(a, t) {
    ...
    if (Array.isArray(a)) {
      for (let s = 0; s < a.length; s++) a[s] = Mt(a[s], t);
      return a;
    }
    let e = Os(a);
    for (let s = 0; s < e.length; s++) a[e[s]] = Mt(a[e[s]], t);
    return t(a) || a;
  }
  var Ve = Mt;
  function ta(a, t) {
  ...
  var he = (a) => oe(la(a)),
    ...
    aa = ["recordAndTuple", { syntaxType: "hash" }],
    _s = "v8intrinsic",
    Us = [
    ...
    R = (a, t = ra) => ({ ...t, plugins: [...t.plugins, ...a] }),
    na = /@(?:no)?flow\b/;
  function oa(a, t) {
    var i;
    ...
    let s = bs(a, 0);
    return s !== !1 && (a = a.slice(0, s)), na.test(a);
  }
  function ha(a, t, e) {
    let s = a(t, e),
      i = s.errors.find((r) => !ca.has(r.reasonCode));
    if (i) throw i;
    return s;
  }
  function la({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      if ((s.parser === "babel" || s.parser === "__babel_estree") && oa(e, s))
        return (s.parser = "babel-flow"), qs.parse(e, s);
      let i = t;
      (s.__babelSourceType ?? Rs(s)) === "script" &&
        (i = i.map((l) => ({ ...l, sourceType: "script" }))),
        /#[[{]/.test(e) && (i = i.map((l) => R([aa], l)));
      let n = /%[A-Z]/.test(e);
      e.includes("|>")
        ? (i = (n ? [...Us, _s] : Us).flatMap((c) => i.map((u) => R([c], u))))
        : n && (i = i.map((l) => R([_s], l)));
      let o = a ? Ke.parseExpression : Ke.parse,
        h;
      try {
      ...
      return (
        a && (h = ze(h, { text: e, rootMarker: s.rootMarker })),
        Bs(h, { parser: "babel", text: e })
      );
    };
  }
  var ca = new Set([
    ...
    Ks = [R(["jsx"])],
    js = he({ optionsCombinations: Ks }),
    $s = he({
      optionsCombinations: [R(["jsx", "typescript"]), R(["typescript"])],
    }),
    Vs = he({ isExpression: !0, optionsCombinations: [R(["jsx"])] }),
    zs = he({ isExpression: !0, optionsCombinations: [R(["typescript"])] }),
    qs = he({
      optionsCombinations: [
        R(["jsx", ["flow", { all: !0, enums: !0 }], "flowComments"]),
      ],
    }),
    pa = he({ optionsCombinations: Ks.map((a) => R(["estree"], a)) }),
    Hs = {
      babel: js,
      "babel-flow": qs,
      "babel-ts": $s,
      ...
      __ts_expression: zs,
      __vue_expression: Vs,
      __vue_ts_expression: zs,
      __vue_event_binding: js,
      __vue_ts_event_binding: $s,
      __babel_estree: pa,
    };
  var Js = qe(kt(), 1);
  function Xs(a = {}) {
    ...
    return function (s) {
      let i;
      try {
        i = (0, Js.parseExpression)(s, { tokens: !0, ranges: !0 });
      } catch (r) {
        throw (r == null ? void 0 : r.reasonCode) === "MissingPlugin" ||
          (r == null ? void 0 : r.reasonCode) === "MissingOneOfPlugins"
          ? Ae({ message: "Unexpected token", loc: r.loc })
          : Ae(r);
      }
      if (!t && Y(i.comments)) throw H(i.comments[0], "Comment");
