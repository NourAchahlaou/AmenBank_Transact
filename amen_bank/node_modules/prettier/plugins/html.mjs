...
var Y = (t, e, r) => (
    Hr(t, e, "read from private field"), r ? r.call(t) : e.get(t)
  ),
  Vr = (t, e, r) => {
    if (e.has(t))
  ...
  Ur = (t, e, r, n) => (
    Hr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
  );
var Rr = {};
qr(Rr, {
  languages: () => Fs,
...
var _e = "string",
  ...
  Te = "label",
  le = "break-parent",
  ot = new Set([ve, se, ie, ye, Q, ae, ue, oe, be, we, V, Te, le]);
function Ms(t) {
  if (typeof t == "string") return _e;
  if (Array.isArray(t)) return De;
  if (!t) return;
  let { type: e } = t;
  if (ot.has(e)) return e;
}
var xe = Ms;
var Os = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function qs(t) {
...
var Wr = () => {},
  ...
  ct = Wr;
function U(t) {
  return X(t), { type: se, contents: t };
}
function Gr(t, e) {
  return X(e), { type: ie, contents: e, n: t };
}
function D(t, e = {}) {
  return (
    X(t),
    ct(e.expandedStates, !0),
    {
      type: Q,
      id: e.id,
      contents: t,
...
function Yr(t) {
  return Gr(Number.NEGATIVE_INFINITY, t);
}
function zr(t) {
  return Gr({ type: "root" }, t);
}
function pt(t) {
  return ct(t), { type: ae, parts: t };
}
function ce(t, e = "", r = {}) {
  return (
    X(t),
    e !== "" && X(e),
    { type: ue, breakContents: t, flatContents: e, groupId: r.groupId }
  );
}
function jr(t, e) {
  return X(t), { type: oe, contents: t, groupId: e.groupId, negate: e.negate };
}
var J = { type: le };
var Hs = { type: V, hard: !0 },
  Vs = { type: V, hard: !0, literal: !0 },
  _ = { type: V },
  x = { type: V, soft: !0 },
  S = [Hs, J],
  Kr = [Vs, J];
  ...
  function s(i) {
    switch (xe(i)) {
      ...
      case Q: {
        ...
        return (
          a ? ((a = a.map(n)), (u = a[0])) : (u = n(u)),
          e({ ...i, contents: u, expandedStates: a })
        );
      }
      case ie:
      case se:
  ...
  switch (xe(t)) {
    ...
    case De: {
      ...
      for (let r of t) {
        ...
        typeof n == "string" && typeof ke(!1, e, -1) == "string"
          ? (e[e.length - 1] += n)
          : e.push(n),
          e.push(...s);
      }
...
en.ignoredProperties = zs;
var tn = en;
var js = (t) => t.split(/[/\\]/).pop();
function rn(t, e) {
  if (!e) return;
  let r = js(e).toLowerCase();
  return t.find((n) => {
    var s, i;
    return (
...
var R,
  er = class {
    ...
    hasLeadingWhitespace(e) {
      return Y(this, R).has(e.charAt(0));
    }
    hasTrailingWhitespace(e) {
      return Y(this, R).has(ke(!1, e, -1));
    }
    trimStart(e) {
      let r = this.getLeadingWhitespaceCount(e);
      return e.slice(r);
...
var ei = (t) => v(!1, t, /^[\t\f\r ]*\n/g, ""),
  ...
  ln = (t) => {
    let e = t,
      r = z.getLeadingWhitespace(e);
    r && (e = e.slice(r.length));
    let n = z.getTrailingWhitespace(e);
    return (
...
function mt(t, e) {
  return !!(
    ...
    (Ct(t, e) && !M(t) && t.type !== "interpolation")
  );
}
function He(t) {
  return t.type === "attribute" || !t.parent || !t.prev ? !1 : ti(t.prev);
}
function ti(t) {
...
function M(t) {
  return (
    ...
    (t.fullName === "script" ||
      ...
      (pe(t) && (t.name === "script" || t.name === "style")))
  );
}
function cn(t) {
  return t.children && !M(t);
}
function pn(t) {
  return M(t) || t.type === "interpolation" || rr(t);
}
function rr(t) {
  return Dn(t).startsWith("pre");
}
function hn(t, e) {
  var s, i;
  let r = n();
      ...
      : !(
          (!t.prev &&
            (t.parent.type === "root" ||
              ...
              M(t.parent) ||
              We(t.parent, e) ||
              !ui(t.parent.cssDisplay))) ||
          (t.prev && !ci(t.prev.cssDisplay))
        );
  }
}
function fn(t, e) {
  return Be(t)
    ...
    : !(
        ...
        (t.next && !li(t.next.cssDisplay))
      );
}
function mn(t) {
  return pi(t.cssDisplay) && !M(t);
}
function Ve(t) {
  return (
    Be(t) ||
  ...
  return (
    ...
    (t.type === "element" &&
      ...
      (["body", "script", "style"].includes(t.name) ||
        t.children.some((e) => ni(e)))) ||
    (t.firstChild &&
      t.firstChild === t.lastChild &&
      t.firstChild.type !== "text" &&
      Cn(t.firstChild) &&
      (!t.lastChild.isTrailingSpaceSensitive || Sn(t.lastChild)))
  );
}
function nr(t) {
  return (
...
function dt(t) {
  return En(t) || (t.prev && ri(t.prev)) || gn(t);
}
function ri(t) {
  return En(t) || (t.type === "element" && t.fullName === "br") || gn(t);
}
function gn(t) {
  return Cn(t) && Sn(t);
}
...
function gt(t) {
  return t.lastChild ? gt(t.lastChild) : t;
}
function ni(t) {
  var e;
...
function si(t, e) {
  ...
  return !i && !s ? "babel" : Le(e, { language: i }) ?? An(s);
}
function ii(t, e) {
  if (!Ct(t, e)) return;
  let { attrMap: r } = t;
  ...
  let { type: n, lang: s } = r;
  return Le(e, { language: s }) ?? An(n);
}
function ai(t, e) {
  if (t.name !== "style") return;
  let { lang: r } = t.attrMap;
  return r ? Le(e, { language: r }) : "css";
}
function sr(t, e) {
  return si(t, e) ?? ai(t, e) ?? ii(t, e);
}
function Ue(t) {
  return t === "block" || t === "list-item" || t.startsWith("table");
}
function ui(t) {
  return !Ue(t) && t !== "inline-block";
}
function oi(t) {
  return !Ue(t) && t !== "inline-block";
}
...
function _n(t, e) {
  ...
  if (t.type === "element" && t.namespace === "svg")
    if (hi(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    default:
      return (
        (t.type === "element" && (!t.namespace || r || pe(t)) && sn[t.name]) ||
        nn
      );
  }
}
function Dn(t) {
  return (t.type === "element" && (!t.namespace || pe(t)) && un[t.name]) || an;
}
function fi(t) {
...
`)) {
    ...
    let n = z.getLeadingWhitespaceCount(r);
    if (n === 0) return 0;
    r.length !== n && n < e && (e = n);
  }
  return e === Number.POSITIVE_INFINITY ? 0 : e;
}
function ir(t, e = fi(t)) {
  return e === 0
    ? t
    : t
        .split(
...
var mi = new Set(["template", "style", "script"]);
function We(t, e) {
  return fe(t, e) && !mi.has(t.fullName);
}
function fe(t, e) {
  return (
    e.parser === "vue" &&
...
function Ct(t, e) {
  return (
    fe(t, e) && (We(t, e) || (t.attrMap.lang && t.attrMap.lang !== "html"))
  );
}
function vn(t) {
  let e = t.fullName;
...
function bn(t) {
  return (t >= 97 && t <= 102) || (t >= 65 && t <= 70) || di(t);
}
function lr(t) {
  return t === 10 || t === 13;
}
...
var gi = /-+([a-z0-9])/g;
function xn(t) {
  return t.replace(gi, (...e) => e[1].toUpperCase());
}
var ee = class t {
    constructor(e, r, n, s) {
...
var Pe = class {
  constructor(e, r, n = At.ERROR) {
    (this.span = e), (this.msg = r), (this.level = n);
  }
  contextualMessage() {
    let e = this.span.start.getContext(100, 3);
    return e
      ? `${this.msg} ("${e.before}[${At[this.level]} ->]${e.after}")`
      : this.msg;
  }
  toString() {
...
var Ci = [Ei, Ai, Di, yi, bi, xi, wi, Ti, ki, vi];
function Si(t, e) {
  for (let r of Ci) r(t, e);
  return t;
}
function Ei(t) {
  t.walk((e) => {
    ...
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        let i = s.prev,
          a = s.firstChild;
        r.removeChild(i), n--;
        let u = new m(i.sourceSpan.start, a.sourceSpan.end),
          o = new m(u.start, s.sourceSpan.end);
    ...
    if (n.children)
      for (let s = 0; s < n.children.length; s++) {
        ...
        !a ||
          a.type !== "text" ||
          ((a.value += i.value),
          (a.sourceSpan = new m(a.sourceSpan.start, i.sourceSpan.end)),
          n.removeChild(i),
          s--);
      }
  });
...
function vi(t) {
  let e = (r) => {
    ...
    return (
      ...
      !z.hasWhitespaceCharacter(r.children[0].value) &&
    ...
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        (i.value +=
          ...
          (i.sourceSpan = new m(i.sourceSpan.start, a.sourceSpan.end)),
                  ...
                  : [
                      {
                        type: "text",
                        value: p,
                        sourceSpan: new m(i.moveBy(2), a.moveBy(-2)),
                      },
                    ],
            });
        }
...
function bi(t) {
  t.walk((e) => {
    ...
    if (
      ...
      (e.children.length === 1 &&
        e.children[0].type === "text" &&
        z.trim(e.children[0].value).length === 0)
    ) {
        ...
        u
          ? ((i.value = u),
            (i.sourceSpan = new m(
              ...
              i.sourceSpan.end.moveBy(-o.length),
            )),
            a && (p && (p.hasTrailingSpaces = !0), (i.hasLeadingSpaces = !0)),
            o && ((i.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)))
          : (e.removeChild(i),
            s--,
            (a || o) &&
...
function ki(t, e) {
  t.walk((r) => {
    ...
    if (n) {
      if (n.length === 0) {
        r.isDanglingSpaceSensitive = mn(r);
        return;
      }
      for (let s of n)
        (s.isLeadingSpaceSensitive = hn(s, e)),
          (s.isTrailingSpaceSensitive = fn(s, e));
...
async function Bi(t, e) {
  if (t.lang === "yaml") {
    ...
    return zr([t.startDelimiter, S, n, n ? S : "", t.endDelimiter]);
  }
}
var Fn = Bi;
var Pn = new Proxy(() => {}, { get: () => Pn }),
  pr = Pn;
function Li(t) {
...
var Nn = Li;
function Ge(t, e) {
  return [t.isSelfClosing ? "" : Fi(t, e), Ye(t, e)];
}
function Fi(t, e) {
  return t.lastChild && Ce(t.lastChild) ? "" : [Pi(t, e), _t(t, e)];
}
function Ye(t, e) {
  return (t.next ? W(t.next) : ge(t.parent)) ? "" : [de(t, e), O(t, e)];
}
function Pi(t, e) {
  return ge(t) ? de(t.lastChild, e) : "";
}
function O(t, e) {
  return Ce(t) ? _t(t.parent, e) : ze(t) ? Dt(t.next) : "";
}
function _t(t, e) {
  if ((pr(!t.isSelfClosing), In(t, e))) return "";
  switch (t.type) {
    case "ieConditionalComment":
      return "<!";
    case "element":
...
function In(t, e) {
  return !t.isSelfClosing && !t.endSourceSpan && (He(t) || mt(t.parent, e));
}
function W(t) {
  return (
    t.prev &&
...
function Ce(t) {
  return (
    !t.next && !t.hasTrailingSpaces && t.isTrailingSpaceSensitive && P(gt(t))
  );
}
function ze(t) {
  return (
...
function Ii(t, e, r) {
  var f;
  let { node: n } = t;
  if (!Nn(n.attrs)) return n.isSelfClosing ? " " : "";
  let s =
    ...
    i =
      typeof s == "boolean"
        ...
        : () => !1,
    a = t.map(
      ({ node: d }) => (i(d) ? w(e.originalText.slice(te(d), re(d))) : r()),
      "attrs",
    ),
    u =
      n.type === "element" &&
      ...
      n.children.length === 0,
    p = e.singleAttributePerLine && n.attrs.length > 1 && !fe(n, e) ? S : _,
    l = [U([u ? " " : _, Z(p, a)])];
  return (
    (n.firstChild && je(n.firstChild)) || (n.isSelfClosing && ge(n.parent)) || u
...
function Ri(t) {
  return t.firstChild && je(t.firstChild) ? "" : vt(t);
}
function Ke(t, e, r) {
  let { node: n } = t;
  return [Qe(n, e), Ii(t, e, r), n.isSelfClosing ? "" : Ri(n)];
}
function Qe(t, e) {
  return t.prev && ze(t.prev) ? "" : [q(t, e), Dt(t)];
}
function q(t, e) {
  return je(t) ? vt(t.parent) : W(t) ? de(t.prev, e) : "";
}
function Dt(t) {
  switch (t.type) {
    case "ieConditionalComment":
...
function vt(t) {
  switch ((pr(!t.isSelfClosing), t.type)) {
    case "ieConditionalComment":
      return "]>";
    case "element":
  ...
  return (
    hr.has(r) ||
      hr.set(
        r,
        r.children.some(
          (n) => Et(n, e) && ["ts", "typescript"].includes(n.attrMap.lang),
        ),
      ),
    hr.get(r)
  );
...
function Mi(t, e) {
  ...
  t.firstChild && je(t.firstChild) && (r -= vt(t).length);
  let n = t.endSourceSpan.start.offset;
  return (
    t.lastChild && Ce(t.lastChild)
      ? (n += _t(t, e).length)
      : ge(t) && (n -= de(t.lastChild, e).length),
...
function Wi(t) {
  ...
  function p(C) {
    let E,
      A = C.exec(t.substring(u));
    if (A) return ([E] = A), (u += E.length), E;
  }
  let l = [];
  for (;;) {
    if ((p(qi), u >= e)) {
    ...
    (o = u),
      (r = p(Hi)),
      (n = []),
      r.slice(-1) === "," ? ((r = r.replace(Vi, "")), d()) : f();
  }
  function f() {
    for (p(Oi), s = "", i = "in descriptor"; ; ) {
      if (((a = t.charAt(u)), i === "in descriptor"))
        if (Rn(a)) s && (n.push(s), (s = ""), (i = "after descriptor"));
        else if (a === ",") {
          (u += 1), s && n.push(s), d();
          return;
      ...
      else if (i === "after descriptor" && !Rn(a))
        if (a === "") {
          d();
          return;
    ...
    for (T = 0; T < n.length; T++)
      (g = n[T]),
        ...
        $n.test(I) && y === "w"
          ...
          : (C = !0);
    if (!C)
      (c.source = { value: r, startOffset: o }),
        E && (c.width = { value: E }),
        A && (c.density = { value: A }),
        F && (c.height = { value: F }),
        l.push(c);
...
var On = { width: "w", height: "h", density: "x" },
  Yi = Object.keys(On);
function zi(t) {
  let e = Mn(t),
    r = Yi.filter((l) =>
  ...
  let [n] = r,
    ...
    u = e.map((l) => (l[n] ? String(l[n].value) : "")),
    o = u.map((l) => {
      let f = l.indexOf(".");
...
function Vn(t, e) {
  ...
  if (r.fullName === "style" && !e.parentParser && !n.includes("{{"))
    return async (s) =>
      Se(await s(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
}
async function Un(t, e, r, n) {
  let s = k(r.node),
    { left: i, operator: a, right: u } = Ki(s),
    o = Ne(r, n);
  return [
    D(
      await B(`function _(${i}) {}`, t, {
    ...
    a,
    " ",
    await B(u, t, { parser: o ? "__ts_expression" : "__js_expression" }),
  ];
}
function Ki(t) {
  let e = /(.*?)\s+(in|of)\s+(.*)/s,
...
function Gn(t, e, { parseWithTs: r }) {
  return B(`function _(${t}) {}`, e, {
...
function Qi(t, e) {
  ...
  let { node: r } = t,
    n = r.fullName;
  if (n === "v-for") return Un;
  if (n === "generic" && Et(r.parent, e)) return Wn;
  let s = k(r),
    i = Ne(t, e);
  if (vn(r) || yn(r, e)) return (a) => Gn(s, a, { parseWithTs: i });
  ...
  if (n.startsWith("v-")) return (a) => zn(s, a, { parseWithTs: i });
}
function Xi(t, e, { parseWithTs: r }) {
  return Yn(t)
    ? zn(t, e, { parseWithTs: r })
    : B(
        t,
        e,
...
function zn(t, e, { parseWithTs: r }) {
  return B(t, e, { parser: r ? "__ts_expression" : "__js_expression" }, ne);
}
var jn = Qi;
var fr = /{{(.+?)}}/s;
...
function mr({ parser: t }) {
  return (e, r, n) => B(k(n.node), e, { parser: t, trailingComma: "none" }, ne);
}
var Zi = mr({ parser: "__ng_action" }),
  ea = mr({ parser: "__ng_binding" }),
  ta = mr({ parser: "__ng_directive" });
function ra(t, e) {
  ...
  if (
    ...
    return ea;
  if (n.startsWith("*")) return ta;
  let s = k(r);
  if (/^i18n(?:-.+)?$/.test(n))
    return () => Se(pt(St(r, s.trim())), !s.includes("@@"));
  if (fr.test(s)) return (i) => Kn(s, i);
}
var Qn = ra;
function na(t, e) {
  let { node: r } = t;
...
function ia(t, e) {
  ...
  switch (r.type) {
    case "element":
      if (M(r) || r.type === "interpolation") return;
      if (!r.isSelfClosing && Ct(r, e)) {
        let n = sr(r, e);
        return n
          ? async (s, i) => {
              let a = yt(r, e),
              ...
              return (
                u ||
                  ((o = await s(tr(a), { parser: n, __embeddedInHtml: !0 })),
                  (u = o === "")),
                [
                  q(r, e),
                  D(Ke(t, e, i)),
      ...
      if (M(r.parent)) {
        ...
        if (n)
          return async (s) => {
            ...
            if (e.parser === "html" && n === "babel") {
              ...
              o &&
                (o.type === "module" ||
                  (o.type === "text/babel" && o["data-type"] === "module")) &&
                (u = "module"),
                (a.__babelSourceType = u);
            }
            return [
              J,
              q(r, e),
        ...
        return async (n) => {
          ...
          return (
            ...
            [
              U([_, await n(r.value, s)]),
              r.parent.next && W(r.parent.next) ? " " : _,
            ]
          );
        };
      break;
...
function Xe(t, e, r) {
  ...
  return He(n)
    ? [
        ...
        w(
          e.originalText.slice(
            te(n) + (n.prev && ze(n.prev) ? Dt(n).length : 0),
            re(n) - (n.next && W(n.next) ? de(n, e).length : 0),
          ),
        ),
        O(n, e),
      ]
...
function bt(t, e) {
  return P(t) && P(e)
    ...
    : (ze(t) &&
      ...
      (t.type === "element" && t.isSelfClosing && W(e))
    ? ""
...
function wt(t, e, r) {
  ...
  if (nr(n))
    return [
      ...
      ...t.map((i) => {
        let a = i.node,
          u = a.prev ? bt(a.prev, a) : "";
        return [u ? [u, Ve(a.prev) ? S : ""] : "", Xe(i, e, r)];
      }, "children"),
    ];
  ...
  return t.map((i, a) => {
    ...
    if (P(u)) {
      if (u.prev && P(u.prev)) {
        let E = bt(u.prev, u);
        if (E) return Ve(u.prev) ? [S, S, Xe(i, e, r)] : [E, Xe(i, e, r)];
      }
      return Xe(i, e, r);
    }
    let o = [],
      ...
      l = [],
      f = [],
      d = u.prev ? bt(u.prev, u) : "",
      C = u.next ? bt(u, u.next) : "";
    return (
      d &&
        (Ve(u.prev)
          ? o.push(S, S)
...
function Zn(t, e, r) {
  let { node: n } = t;
  if (mt(n, e))
    return [q(n, e), D(Ke(t, e, r)), w(yt(n, e)), ...Ge(n, e), O(n, e)];
  let s =
      n.children.length === 1 &&
    ...
    a = (l) => D([D(Ke(t, e, r), { id: i }), l, Ge(n, e)]),
    u = (l) =>
      s
        ? jr(l, { groupId: i })
        : (M(n) || We(n, e)) &&
...
function ca(t, e, r) {
  ...
  switch (n.type) {
    case "front-matter":
      return w(n.raw);
    case "root":
      return e.__onHtmlRoot && e.__onHtmlRoot(n), [D(wt(t, e, r)), S];
    case "element":
    case "ieConditionalComment":
      return Zn(t, e, r);
    case "ieConditionalStartComment":
    case "ieConditionalEndComment":
      return [Qe(n), Ye(n)];
    case "interpolation":
      return [Qe(n, e), ...t.map(r, "children"), Ye(n, e)];
    case "text": {
      if (n.parent.type === "interpolation") {
        let i = /\n[^\S\n]*$/,
          a = i.test(n.value),
          u = a ? n.value.replace(i, "") : n.value;
        return [w(u), a ? S : ""];
      }
      let s = Qr([q(n, e), ...St(n), O(n, e)]);
      return Array.isArray(s) ? pt(s) : s;
    }
    case "docType":
      return [
        D([
    ...
    case "comment":
      return [q(n, e), w(e.originalText.slice(te(n), re(n))), O(n, e)];
    case "attribute": {
...
var pa = {
  ...
  ns = pa;
var Nr = {};
qr(Nr, { angular: () => su, html: () => nu, lwc: () => au, vue: () => iu });
var _c = new RegExp(
  `(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`,
  "g",
);
...
var gr = { name: "custom-elements" },
  Cr = { name: "no-errors-schema" };
var j;
(function (t) {
  (t[(t.NONE = 0)] = "NONE"),
    (t[(t.HTML = 1)] = "HTML"),
...
function Sr(t) {
  return et(t)[1] === "ng-container";
}
function Er(t) {
  return et(t)[1] === "ng-content";
}
function Ie(t) {
  return t === null ? null : et(t)[0];
}
function Re(t, e) {
  return t ? `:${t}:${e}` : e;
}
...
function Ar() {
  return (
    xt ||
      ((xt = {}),
      Tt(j.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
      Tt(j.STYLE, ["*|style"]),
      Tt(j.URL, [
        "*|formAction",
        "area|href",
...
function Tt(t, e) {
  for (let r of e) xt[r.toLowerCase()] = t;
}
var kt = class {};
var ha = "boolean",
  fa = "number",
  ...
  Ca = Array.from(us).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
  Bt = class extends kt {
    constructor() {
      super(),
        ...
        ga.forEach((e) => {
          ...
          if (p) {
            ...
            for (let l of this._eventSchema.get(o.toLowerCase())) n.add(l);
          }
          a.forEach((l) => {
            if (l.length > 0)
              switch (l[0]) {
    ...
    hasProperty(e, r, n) {
      if (n.some((i) => i.name === Cr.name)) return !0;
      if (e.indexOf("-") > -1) {
        if (Sr(e) || Er(e)) return !1;
        if (n.some((i) => i.name === gr.name)) return !0;
      }
      return (
    ...
    hasElement(e, r) {
      return r.some((n) => n.name === Cr.name) ||
        (e.indexOf("-") > -1 &&
          (Sr(e) || Er(e) || r.some((n) => n.name === gr.name)))
        ? !0
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
    ...
    allKnownAttributesOfElement(e) {
      ...
      return Array.from(r.keys()).map((n) => Ca.get(n) ?? n);
    }
...
var h = class {
    constructor({
      ...
      contentType: n = L.PARSABLE_DATA,
      closedByParent: s = !1,
      isVoid: i = !1,
      ignoreFirstLf: a = !1,
      preventNamespaceInheritance: u = !1,
      canSelfClose: o = !1,
    } = {}) {
      (this.closedByChildren = {}),
        ...
        (this.preventNamespaceInheritance = u),
        (this.canSelfClose = o ?? i);
    }
    isClosedByChild(e) {
  ...
  return (
    tt ||
      ...
      (tt = {
        ...
        style: new h({ contentType: L.RAW_TEXT }),
        script: new h({ contentType: L.RAW_TEXT }),
        title: new h({
          contentType: { default: L.ESCAPABLE_RAW_TEXT, svg: L.PARSABLE_DATA },
        }),
        textarea: new h({
      ...
      new Bt().allKnownElementNames().forEach((e) => {
        !tt.hasOwnProperty(e) &&
          Ie(e) === null &&
          (tt[e] = new h({ canSelfClose: !1 }));
      })),
    tt[t] ?? os
  );
}
...
var _r = class t {
    static fromArray(e) {
      return e ? (ls("interpolation", e), new t(e[0], e[1])) : Dr;
    }
    constructor(e, r) {
...
function As(t, e, r, n = {}) {
  let s = new wr(new me(t, e), r, n);
  return (
    s.tokenize(), new br(Ya(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
  );
}
var Oa = /\r\n?/g;
function Oe(t) {
  ...
  wr = class {
    constructor(e, r, n) {
      (this._getTagContentType = r),
        ...
        (this._interpolationConfig = n.interpolationConfig || Dr),
      ...
      (this._cursor = n.escapedString ? new Tr(e, s) : new Wt(e, s)),
...
`,
    ...
    _tokenizeExpansionForm() {
      ...
      if (Wa(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _createError(e, r) {
      ...
      let n = new it(e, this._currentTokenType, r);
      return (
        (this._currentTokenStart = null),
        (this._currentTokenType = null),
        new at(n)
    ...
    _attemptCharCodeCaseInsensitive(e) {
      return Ga(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
    }
    _requireCharCode(e) {
      let r = this._cursor.clone();
      if (!this._attemptCharCode(e))
        throw this._createError(
          Oe(this._cursor.peek()),
          this._cursor.getSpan(r),
        );
    }
    _attemptStr(e) {
    ...
    _consumeEntity(e) {
      ...
      if ((this._cursor.advance(), this._attemptCharCode(35))) {
        ...
        if ((this._attemptCharCodeUntilFn(Va), this._cursor.peek() != 59)) {
          this._cursor.advance();
          let a = n ? Ut.HEX : Ut.DEC;
          throw this._createError(
            qa(a, this._cursor.getChars(r)),
        ...
        if ((this._attemptCharCodeUntilFn(Ua), this._cursor.peek() != 59))
          ...
          this._cursor.advance();
          let i = Me[s];
          if (!i) throw this._createError(fs(s), this._cursor.getSpan(r));
          this._endToken([i, `&${s};`]);
        }
      }
    }
    ...
    _consumePrefixAndName() {
      let e = this._cursor.clone(),
        r = "";
      for (; this._cursor.peek() !== 58 && !Ha(this._cursor.peek()); )
        this._cursor.advance();
      let n;
      this._cursor.peek() === 58
        ...
        : (n = e),
        this._requireCharCodeUntilFn(ms, r === "" ? 0 : 1);
      let s = this._cursor.getChars(n);
      return [r, s];
    }
    _consumeTagOpen(e) {
    ...
    _consumeRawTextWithTagClose(e, r, n) {
      this._consumeRawText(n, () =>
        ...
        !this._attemptStrCaseInsensitive(e ? `${e}:${r}` : r))
          ? !1
          : (this._attemptCharCodeUntilFn(N), this._attemptCharCode(62)),
      ),
        this._beginToken(3),
    ...
    _consumeAttributeName() {
      ...
      if (e === 39 || e === 34)
        throw this._createError(Oe(e), this._cursor.getSpan());
      this._beginToken(14);
      let r = this._consumePrefixAndName();
    ...
    _consumeWithInterpolation(e, r, n, s) {
      ...
      for (; !n(); ) {
        ...
        this._attemptStr(this._interpolationConfig.start)
          ? (this._endToken([this._processCarriageReturns(i.join(""))], u),
            (i.length = 0),
            this._consumeInterpolation(r, u, s),
            this._beginToken(e))
    ...
    _consumeInterpolation(e, r, n) {
      ...
      for (; this._cursor.peek() !== 0 && (n === null || !n()); ) {
        ...
        if (this._isTagStart()) {
          (this._cursor = o),
            s.push(this._getProcessedChars(i, o)),
            this._endToken(s);
          return;
        }
        if (a === null)
...
function Va(t) {
  return t === 59 || t === 0 || !bn(t);
}
function Ua(t) {
  return t === 59 || t === 0 || !or(t);
}
function Wa(t) {
  return t !== 125;
}
...
var Wt = class t {
    ...
    advanceState(e) {
      if (e.offset >= this.end)
        throw ((this.state = e), new ut('Unexpected character "EOF"', this));
      let r = this.charAt(e.offset);
      r === 10 ? (e.line++, (e.column = 0)) : lr(r) || e.column++,
        e.offset++,
        this.updatePeek(e);
    }
    updatePeek(e) {
    ...
    locationFromCursor(e) {
      return new ee(e.file, e.state.offset, e.state.line, e.state.column);
    }
  },
  Tr = class t extends Wt {
    constructor(e, r) {
      e instanceof t
    ...
    decodeHexDigits(e, r) {
      ...
      if (isNaN(s))
        throw (
          ...
          new ut("Invalid hexadecimal escape sequence", e))
        );
      return s;
    }
  },
  ...
  Gt = class {
    ...
    parse(e, r, n, s = !1, i) {
      let a =
          ...
          (F, ...T) =>
            A(F.toLowerCase(), ...T),
        u = s ? this.getTagDefinition : a(this.getTagDefinition),
        o = (A) => u(A).getContentType(),
        p = s ? i : a(i),
        f = As(
          e,
          r,
        ...
        E = new Lr(f.tokens, u, d, C, s);
      return E.build(), new Br(E.rootNodes, f.errors.concat(E.errors));
    }
  },
  Lr = class t {
    constructor(e, r, n, s, i) {
    ...
    _consumeCdata(e) {
      ...
      this._addToParent(
        new Ft(n, new m(e.sourceSpan.start, (s || r).sourceSpan.end), [r]),
      );
    }
    _consumeComment(e) {
      let r = this._advanceIf(7),
        ...
        i = new m(e.sourceSpan.start, (n || r || e).sourceSpan.end);
      this._addToParent(new $t(s, i));
    }
    _consumeDocType(e) {
      let r = this._advanceIf(7),
    ...
    _consumeExpansion(e) {
      ...
      this._addToParent(new Pt(r.parts[0], n.parts[0], s, i, r.sourceSpan)),
        this._advance();
    }
    _parseExpansionCase() {
      let e = this._advance();
      ...
      let a = new m(
        ...
        u = new m(r.sourceSpan.start, s.sourceSpan.end, r.sourceSpan.fullStart);
      return new Nt(e.parts[0], i.rootNodes, a, e.sourceSpan, u);
    }
    _collectExpansionExpTokens(e) {
      ...
      for (;;) {
        ...
        if (this._peek.type === 25)
          return (
            this.errors.push(
              H.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'."),
            ),
            null
          );
...
`
      ...
      if (s.length > 0) {
        let i = e.sourceSpan;
        this._addToParent(
          new Lt(s, new m(n.start, i.end, n.fullStart, n.details), r),
        );
      }
    }
    _closeVoidElement() {
    ...
    _consumeStartTag(e) {
      ...
      let i = this._getElementFullName(r, n, this._getParentElement()),
        a = !1;
      if (this._peek.type === 2) {
        this._advance(), (a = !0);
        let d = this.getTagDefinition(i);
        this.canSelfClose ||
          d.canSelfClose ||
          Ie(i) !== null ||
          d.isVoid ||
      ...
      let u = this._peek.sourceSpan.fullStart,
        o = new m(e.sourceSpan.start, u, e.sourceSpan.fullStart),
        p = new m(e.sourceSpan.start, u, e.sourceSpan.fullStart),
        l = new m(e.sourceSpan.start.moveBy(1), e.sourceSpan.end),
        f = new Rt(i, s, [], o, p, void 0, l);
      this._pushElement(f),
        a
          ? this._popElement(i, o)
          : e.type === 4 &&
            (this._popElement(i, null),
            this.errors.push(
              H.create(i, o, `Opening tag "${i}" not terminated.`),
            ));
    }
    _pushElement(e) {
      let r = this._getParentElement();
      r &&
        this.getTagDefinition(r.name).isClosedByChild(e.name) &&
    ...
    _consumeEndTag(e) {
      ...
      if (r && this.getTagDefinition(r).isVoid)
        ...
        this.errors.push(H.create(r, e.sourceSpan, n));
      }
    }
    _popElement(e, r) {
      let n = !1;
      for (let s = this._elementStack.length - 1; s >= 0; s--) {
        ...
        if (
          !e ||
          (Ie(i.name) ? i.name == e : i.name.toLowerCase() == e.toLowerCase())
        )
          return (
            (i.endSourceSpan = r),
            (i.sourceSpan.end = r !== null ? r.end : i.sourceSpan.end),
            this._elementStack.splice(s, this._elementStack.length - s),
            !n
          );
        this.getTagDefinition(i.name).closedByParent || (n = !0);
      }
      return !1;
    }
    _consumeAttr(e) {
      let r = Re(e.parts[0], e.parts[1]),
        n = e.sourceSpan.end,
        s;
      ...
      if (this._peek.type === 16)
        for (
          u = this._peek.sourceSpan, o = this._peek.sourceSpan.end;
          this._peek.type === 16 ||
          this._peek.type === 17 ||
          this._peek.type === 9;
          ...
          a.push(f),
            f.type === 17
              ? (i += f.parts.join("").replace(/&([^;]+);/g, Ds))
              : f.type === 9
              ? (i += f.parts[0])
              : (i += f.parts.join("")),
            (o = n = f.sourceSpan.end);
        }
      ...
      let l =
        ...
        o &&
        new m(
          (s == null ? void 0 : s.sourceSpan.start) ?? u.start,
          o,
          (s == null ? void 0 : s.sourceSpan.fullStart) ?? u.fullStart,
        );
      return new It(
        r,
        i,
        new m(e.sourceSpan.start, n, e.sourceSpan.fullStart),
        e.sourceSpan,
        l,
        a.length > 0 ? a : void 0,
        void 0,
...
var Ja = [
  { regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: Za },
  { regex: /^\[if([^\]]*)]><!$/, parse: eu },
  { regex: /^<!\s*\[endif]$/, parse: tu },
];
function Ts(t, e) {
  if (t.value)
    for (let { regex: r, parse: n } of Ja) {
...
function Za(t, e, r) {
  let [, n, s, i] = r,
    a = 4 + n.length,
    u = t.sourceSpan.start.moveBy(a),
    o = u.moveBy(i.length),
    [p, l] = (() => {
      try {
        return [!0, e(i, u).children];
      } catch {
  ...
  return {
    ...
    startSourceSpan: new m(t.sourceSpan.start, u),
    endSourceSpan: new m(o, t.sourceSpan.end),
  };
}
function eu(t, e, r) {
  let [, n] = r;
...
function ks(t, e, r) {
  let {
    ...
    { rootNodes: l, errors: f } = Pr(t, {
      canSelfClose: s,
      allowHtmComponentClosingTags: u,
      isTagNameCaseSensitive: o,
      getTagContentType: p ? (...c) => (p(...c) ? L.RAW_TEXT : void 0) : void 0,
    });
  if (n === "vue") {
    if (
      l.some(
    ...
    let g,
      ...
      I = (b) =>
        y().rootNodes.find(
          ({ startSourceSpan: $ }) =>
            $ && $.start.offset === b.startSourceSpan.start.offset,
        ) ?? b;
    for (let [b, $] of l.entries()) {
      let { endSourceSpan: $r, startSourceSpan: Is } = $;
      if ($r === null) (f = y().errors), (l[b] = I($));
      else if (ru($, r)) {
        let Mr = y().errors.find(
          (Or) =>
            Or.span.start.offset > Is.start.offset &&
            Or.span.start.offset < $r.end.offset,
        );
        Mr && xs(Mr), (l[b] = I($));
      }
    }
  ...
  let d = (c) => {
      let g = c.name.startsWith(":") ? c.name.slice(1).split(":")[0] : null,
        ...
        I = g !== null && y.startsWith(`${g}:`),
        b = I ? y.slice(g.length + 1) : y;
      (c.name = b), (c.namespace = g), (c.hasExplicitNamespace = I);
    },
    C = (c) => {
      switch (c.type) {
        case "element":
        ...
        for (let g of c.attrs)
          g.namespace ||
            (g.name = E(
              g.name,
              (y) =>
                zt.has(c.name) && (zt.get("*").has(y) || zt.get(c.name).has(y)),
            ));
    },
    F = (c) => {
      c.sourceSpan &&
        c.endSourceSpan &&
        (c.sourceSpan = new m(c.sourceSpan.start, c.endSourceSpan.end));
    },
    T = (c) => {
      if (c.type === "element") {
        let g = $e(o ? c.name : c.name.toLowerCase());
        !c.namespace || c.namespace === g.implicitNamespacePrefix || pe(c)
          ? (c.tagDefinition = g)
          : (c.tagDefinition = $e(""));
      }
    };
...
function Bs(t, e, r = {}, n = !0) {
  let { frontMatter: s, content: i } = n
      ? vs(t)
      : { frontMatter: null, content: t },
    a = new me(t, r.filepath),
    u = new ee(a, 0, 0, 0),
    o = u.moveBy(t.length),
    p = { type: "root", sourceSpan: new m(u, o), children: ks(i, e, r) };
  if (s) {
    let d = new ee(a, 0, 0, 0),
      C = d.moveBy(s.raw.length);
    (s.sourceSpan = new m(d, C)), p.children.unshift(s);
  }
  let l = new Kt(p),
    f = (d, C) => {
      let { offset: E } = C,
        A = v(!1, t.slice(0, E), /[^\n\r]/g, " "),
        T = Bs(A + d, e, r, !1);
      T.sourceSpan = new m(C, ke(!1, T.children, -1).sourceSpan.end);
      let c = T.children[0];
      return (
        c.length === E
          ? T.children.shift()
          : ((c.sourceSpan = new m(
              c.sourceSpan.start.moveBy(E),
              c.sourceSpan.end,
            )),
            (c.value = c.value.slice(E))),
        T
      );
    };
  return (
