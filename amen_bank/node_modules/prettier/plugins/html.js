      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of $s(e))
          !Ms.call(t, s) &&
            ...
            Xt(t, s, {
              get: () => e[s],
              enumerable: !(n = Rs(e, s)) || n.enumerable,
            });
      return t;
    };
  var qs = (t) => Os(Xt({}, "__esModule", { value: !0 }), t);
  var Hr = (t, e, r) => {
...
Expected it to be ${n}.`;
  ...
  function jr(t, e) {
    return (
      X(t), { type: oe, contents: t, groupId: e.groupId, negate: e.negate }
    );
  }
  var J = { type: le };
  var Gs = { type: V, hard: !0 },
    Ys = { type: V, hard: !0, literal: !0 },
    _ = { type: V },
    x = { type: V, soft: !0 },
    S = [Gs, J],
    Kr = [Ys, J];
...
`,
  ...
  function pn(t) {
    return M(t) || t.type === "interpolation" || nr(t);
  }
  function nr(t) {
        ...
        : !(
            (!t.prev &&
              (t.parent.type === "root" ||
                ...
                M(t.parent) ||
                We(t.parent, e) ||
                !pi(t.parent.cssDisplay))) ||
            (t.prev && !mi(t.prev.cssDisplay))
          );
    }
  }
  function fn(t, e) {
  ...
  function dt(t) {
    return En(t) || (t.prev && ai(t.prev)) || gn(t);
  }
  function ai(t) {
  ...
  function Dn(t) {
    return (
      (t.type === "element" && (!t.namespace || pe(t)) && un[t.name]) || an
    );
  }
  function Ci(t) {
...
`);
  ...
  var Si = new Set(["template", "style", "script"]);
  function We(t, e) {
    return fe(t, e) && !Si.has(t.fullName);
  }
  function fe(t, e) {
    return (
      e.parser === "vue" &&
  ...
  function bn(t) {
    return (t >= 97 && t <= 102) || (t >= 65 && t <= 70) || Ei(t);
  }
  function cr(t) {
    return t === 10 || t === 13;
  }
  ...
  var Ai = /-+([a-z0-9])/g;
  function xn(t) {
    return t.replace(Ai, (...e) => e[1].toUpperCase());
  }
  var ee = class t {
      constructor(e, r, n, s) {
...
` && ++u == r
  ...
  var _i = [vi, yi, wi, xi, ki, Fi, Bi, Li, Pi, Ti];
  function Di(t, e) {
    for (let r of _i) r(t, e);
    return t;
  }
  function vi(t) {
    t.walk((e) => {
...
` + t
  ...
  var Nn = Ii;
  function Ge(t, e) {
    return [t.isSelfClosing ? "" : Ri(t, e), Ye(t, e)];
  }
  function Ri(t, e) {
    return t.lastChild && Ce(t.lastChild) ? "" : [$i(t, e), _t(t, e)];
  }
  function Ye(t, e) {
  ...
  function _t(t, e) {
    if ((hr(!t.isSelfClosing), In(t, e))) return "";
    switch (t.type) {
      case "ieConditionalComment":
        return "<!";
      case "element":
  ...
  function Oi(t, e, r) {
    ...
    let s =
      ...
      l = [U([u ? " " : _, Z(p, a)])];
    return (
      (n.firstChild && je(n.firstChild)) ||
      (n.isSelfClosing && ge(n.parent)) ||
      u
  ...
  function Ke(t, e, r) {
    let { node: n } = t;
    return [Qe(n, e), Oi(t, e, r), n.isSelfClosing ? "" : qi(n)];
  }
  function Qe(t, e) {
  ...
  function vt(t) {
    switch ((hr(!t.isSelfClosing), t.type)) {
      case "ieConditionalComment":
        return "]>";
      case "element":
...
` ||
  ...
  async function Un(t, e, r, n) {
    let s = k(r.node),
      { left: i, operator: a, right: u } = Zi(s),
      o = Ne(r, n);
    return [
      D(
  ...
  async function Kn(t, e) {
    let r = [];
    for (let [n, s] of t.split(mr).entries())
      if (n % 2 === 0) r.push(w(s));
      else
        try {
          r.push(
  ...
  function dr({ parser: t }) {
    return (e, r, n) =>
      B(k(n.node), e, { parser: t, trailingComma: "none" }, ne);
  }
  var na = dr({ parser: "__ng_action" }),
    sa = dr({ parser: "__ng_binding" }),
    ia = dr({ parser: "__ng_directive" });
  function aa(t, e) {
    ...
    if (
      ...
      return sa;
    if (n.startsWith("*")) return ia;
    let s = k(r);
    if (/^i18n(?:-.+)?$/.test(n))
      return () => Se(pt(St(r, s.trim())), !s.includes("@@"));
    if (mr.test(s)) return (i) => Kn(s, i);
  }
  var Qn = aa;
  function ua(t, e) {
    let { node: r } = t;
        ...
        if (!r.isSelfClosing && Ct(r, e)) {
          ...
          return n
            ? async (s, i) => {
                ...
                return (
                  u ||
                    ((o = await s(rr(a), { parser: n, __embeddedInHtml: !0 })),
                    (u = o === "")),
                  [
                    q(r, e),
                    D(Ke(t, e, i)),
  ...
  var ca = 10;
  for (let t = 0; t <= ca; t++) Ze();
  function gr(t) {
    return Ze(t);
  }
  function pa(t, e = "type") {
    gr(t);
    function r(n) {
      let s = n[e],
        i = t[s];
  ...
  var da = {
    ...
    ns = da;
  var Ir = {};
  qr(Ir, { angular: () => ou, html: () => uu, lwc: () => cu, vue: () => lu });
  var wc = new RegExp(
    `(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`,
    "g",
  );
  ...
  var Cr = { name: "custom-elements" },
    Sr = { name: "no-errors-schema" };
  var j;
  (function (t) {
    (t[(t.NONE = 0)] = "NONE"),
      (t[(t.HTML = 1)] = "HTML"),
  ...
  var ga = "boolean",
    ...
    _a = Array.from(us).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
    Bt = class extends kt {
      constructor() {
        super(),
              ...
              if (l.length > 0)
                switch (l[0]) {
                  ...
                  case "!":
                    ...
                    break;
                  case "#":
                    r.set(l.substring(1), Ca);
                    break;
                  case "%":
                    r.set(l.substring(1), Ea);
                    break;
                  default:
                    r.set(l, Sa);
                }
      ...
      hasProperty(e, r, n) {
        if (n.some((i) => i.name === Sr.name)) return !0;
        if (e.indexOf("-") > -1) {
          if (Er(e) || Ar(e)) return !1;
      ...
      hasElement(e, r) {
        return r.some((n) => n.name === Sr.name) ||
          (e.indexOf("-") > -1 &&
            (Er(e) || Ar(e) || r.some((n) => n.name === Cr.name)))
          ? !0
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
      ...
      allKnownAttributesOfElement(e) {
        let r =
          this._schema.get(e.toLowerCase()) || this._schema.get("unknown");
        return Array.from(r.keys()).map((n) => _a.get(n) ?? n);
      }
...
`,
  ...
  var Dr = class t {
      static fromArray(e) {
        return e ? (ls("interpolation", e), new t(e[0], e[1])) : vr;
      }
      constructor(e, r) {
  ...
  function As(t, e, r, n = {}) {
    let s = new Tr(new me(t, e), r, n);
    return (
      s.tokenize(),
      new wr(Qa(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
    );
  }
  var Ua = /\r\n?/g;
  function Oe(t) {
    ...
    Tr = class {
      constructor(e, r, n) {
        (this._getTagContentType = r),
          ...
          (this._interpolationConfig = n.interpolationConfig || vr),
        ...
        (this._cursor = n.escapedString ? new xr(e, s) : new Wt(e, s)),
...
`,
      ...
      _tokenizeExpansionForm() {
        ...
        if (ja(this._cursor.peek()) && this._isInExpansionForm())
      ...
      _attemptCharCodeCaseInsensitive(e) {
        return Ka(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
      }
      _requireCharCode(e) {
        let r = this._cursor.clone();
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          if ((this._attemptCharCodeUntilFn(Ya), this._cursor.peek() != 59)) {
            this._cursor.advance();
            let a = n ? Ut.HEX : Ut.DEC;
            throw this._createError(
              Wa(a, this._cursor.getChars(r)),
          ...
          let n = this._cursor.clone();
          if ((this._attemptCharCodeUntilFn(za), this._cursor.peek() != 59))
      ...
      _consumePrefixAndName() {
        let e = this._cursor.clone(),
          r = "";
        for (; this._cursor.peek() !== 58 && !Ga(this._cursor.peek()); )
          this._cursor.advance();
        let n;
  ...
  var Wt = class t {
      ...
      advanceState(e) {
        ...
        r === 10 ? (e.line++, (e.column = 0)) : cr(r) || e.column++,
          e.offset++,
          this.updatePeek(e);
      }
      updatePeek(e) {
    ...
    Gt = class {
      ...
      parse(e, r, n, s = !1, i) {
        let a =
          ...
          E = new Fr(f.tokens, u, d, C, s);
        return E.build(), new Lr(E.rootNodes, f.errors.concat(E.errors));
      }
    },
    Fr = class t {
      constructor(e, r, n, s, i) {
...
`
  ...
  var ru = [
    { regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: nu },
    { regex: /^\[if([^\]]*)]><!$/, parse: su },
    { regex: /^<!\s*\[endif]$/, parse: iu },
  ];
  function Ts(t, e) {
    if (t.value)
      for (let { regex: r, parse: n } of ru) {
          ...
          for (let g of c.attrs)
            g.namespace ||
              (g.name = E(
                ...
                (y) =>
                  zt.has(c.name) &&
                  (zt.get("*").has(y) || zt.get(c.name).has(y)),
              ));
      },
      F = (c) => {
        c.sourceSpan &&
  ...
  var Ps = "HTML",
    pu = {
      bracketSameLine: Rr.bracketSameLine,
      ...
      singleAttributePerLine: Rr.singleAttributePerLine,
