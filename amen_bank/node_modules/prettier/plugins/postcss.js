(function (f) {
  ...
  var ue = (t, e, n) => (
      ...
      Os(
        e || !t || !t.__esModule
          ? Et(n, "default", { value: t, enumerable: !0 })
          : n,
        t,
      )
    ),
    Ql = (t) => Os(Et({}, "__esModule", { value: !0 }), t);
  var Qs = y((pe) => {
    "use strict";
      ...
      function $(U) {
        ...
        switch (((i = r.charCodeAt(d)), i)) {
          ...
          case jt: {
            ...
            while (i === pt || i === Qt || i === Jt || i === Xt || i === jt);
          ...
          case af: {
            if (
              ...
              do {
                ...
                for (p = o; r.charCodeAt(p - 1) === Ht; ) (p -= 1), (f = !f);
              } while (f);
          ...
          case Ht: {
            for (o = d, c = !0; r.charCodeAt(o + 1) === Ht; )
              (o += 1), (c = !c);
            if (
              ((i = r.charCodeAt(o + 1)),
              c &&
...
`,
  ...
  var qe = y((Mx, No) => {
    ...
    var { SourceMapConsumer: Sf, SourceMapGenerator: Cf } = _o(),
      { fileURLToPath: Co, pathToFileURL: ir } = {},
      ...
      Ie = class {
        ...
        error(e, n, r, s = {}) {
          ...
          return (
            ...
            this.file &&
              (ir && (i.input.url = ir(this.file).toString()),
...
`),
  ...
  var ca = y((ib, la) => {
    ...
    var dp = ua(),
      ...
      ge = class {
        constructor(e = []) {
          (this.version = "8.4.27"), (this.plugins = this.normalize(e));
        }
        normalize(e) {
          let n = [];
          for (let r of e)
...
`.charCodeAt(0),
    ...
    Sa.exports = function (e, n = {}) {
      ...
      function H(S) {
        ...
        switch (((i = r.charCodeAt(h)), i)) {
          ...
          case Yn: {
            o = h;
            do (o += 1), (i = r.charCodeAt(o));
            while (i === fr || i === Vn || i === Gn || i === Kn || i === Yn);
          ...
          case Wp: {
            (hr.lastIndex = h + 1),
              hr.test(r),
              hr.lastIndex === 0 ? (o = r.length - 1) : (o = hr.lastIndex - 2),
              (g = ["at-word", r.slice(h, o + 1), h, o]),
              (h = o);
            break;
          }
          case xt: {
            for (o = h, c = !0; r.charCodeAt(o + 1) === xt; )
              (o += 1), (c = !c);
            if (
              ((i = r.charCodeAt(o + 1)),
              c &&
      ...
      return { back: U, nextToken: H, endOfFile: N, position: w };
    };
  });
  var Aa = y((cb, Oa) => {
    var { Comment: Yp } = lr(),
...
`)
          ...
          if (!n || s.trim() === "" || /^[#:A-Za-z-]/.test(s)) super.rule(e);
            ...
            if (o[3]) {
              ...
              i.source.end = { offset: o[3], line: u.line, column: u.col };
            } else {
              let u = this.input.fromOffset(o[2]);
              i.source.end = { offset: o[2], line: u.line, column: u.col };
            }
            for (; e[0][0] !== "word"; ) i.raws.before += e.shift()[1];
            if (e[0][2]) {
              let u = this.input.fromOffset(e[0][2]);
              i.source.start = { offset: e[0][2], line: u.line, column: u.col };
            }
            for (i.prop = ""; e.length; ) {
              let u = e[0][0];
        ...
        comment(e) {
          if (e[4] === "inline") {
            ...
            n.source.end = { offset: e[3], line: r.line, column: r.col };
            let s = e[1].slice(2);
            if (/^\s*$/.test(s))
      ...
      for (; u < i; ) {
        switch (((p = s.charCodeAt(u)), p === bt && ((o = u), (a += 1)), p)) {
          ...
          case ts:
            ...
            r.push(["space", s.slice(u, l), a, u - o, a, l - o, u]),
              (u = l - 1);
            break;
          case Ah:
            (l = u + 1),
          ...
          case Sh:
            ...
            do
              for (
                ...
                (N -= 1), (v = !v);
            while (v);
            r.push(["string", s.slice(u, l + 1), a, u - o, a, l - o, u]),
              (u = l);
            break;
          case Ph:
            (Ar.lastIndex = u + 1),
              Ar.test(s),
              Ar.lastIndex === 0 ? (l = s.length - 1) : (l = Ar.lastIndex - 2),
...
`)),
  ...
  var os = y((Mb, ku) => {
    ...
    function $h(t) {
      for (
        var e = 1, n = t.length, r = t[0], s = t[0], i = 1;
        i < n;
        ++i, s = r
      )
        if (((s = r), (r = t[i]), r !== s)) {
  ...
  var L = y((F) => {
    ...
    var Hb = (F.TAG = "tag"),
      Qb = (F.STRING = "string"),
      jb = (F.SELECTOR = "selector"),
      Jb = (F.ROOT = "root"),
      Xb = (F.PSEUDO = "pseudo"),
      Zb = (F.NESTING = "nesting"),
      ek = (F.ID = "id"),
      tk = (F.COMMENT = "comment"),
      rk = (F.COMBINATOR = "combinator"),
      nk = (F.CLASS = "class"),
      sk = (F.ATTRIBUTE = "attribute"),
      ik = (F.UNIVERSAL = "universal");
  });
  var Ir = y((Rr, Du) => {
    "use strict";
    Rr.__esModule = !0;
          ...
          case xy:
            ...
            do
              for (
                ...
                (g -= 1), (l = !l);
            while (l);
            e.push(["string", n.slice(m, s + 1), d, m - h, d, s - h, m]),
              (m = s);
            break;
          case Ay:
            (Hr.lastIndex = m + 1),
            ...
            break;
          case us:
            for (s = m, c = !0; n.charCodeAt(s + 1) === us; )
              (s += 1), (c = !c);
            (r = n.charCodeAt(s + 1)),
              c &&
                r !== cl &&
...
`)),
    ...
    var hg = (function () {
      ...
      return (
        ...
        (t.prototype.splitWord = function (n, r) {
          ...
          var l = (0, ag.default)(
            (0, Ly.default)((0, Iy.default)([[0], c, f])),
          );
        ...
        (t.prototype.newNode = function (n, r) {
          return (
            ...
            this.spaces &&
              ((n.spaces.before = this.spaces), (this.spaces = "")),
  ...
  var Fe = "string",
    ...
    Ge = "label",
    _e = "break-parent",
    Ot = new Set([Ue, xe, be, We, ke, te, le, ze, Ve, Ye, Q, Ge, _e]);
  function tc(t) {
...
`
  ...
  function It(t) {
    return Rt(t) || Ze(t) || j(t) || he(t) || Nc(t);
  }
  function yi(t) {
  ...
  function qt(t) {
    ...
    return (
      t.type === "value-comma_group" &&
      ((n = (e = t.groups) == null ? void 0 : e[1]) == null
        ? void 0
        : n.type) === "value-colon"
    );
  }
...
`,
  ...
  function pn(t, e) {
    ...
    if (t.type === "css-comment" && t.inline)
      return $t(e, t.source.startOffset);
    if (
  ...
  function Rc(t) {
    ...
    return (
      ...
      t.type === "css-atrule" &&
        ...
        (e +=
          1 + t.name.length + t.raws.afterName.match(/^\s*:?\s*/)[0].length),
      t.type !== "css-atrule" &&
...
` ||
  ...
  var Mi = Uc;
  function Wc(t, e, n = {}) {
    let r = Ft(t, n.backwards ? e - 1 : e, n),
      s = Ut(t, r, n);
    return r !== s;
  }
  var Wt = Wc;
  function zc(t, e) {
    let n = null,
      r = e;
    for (; r !== n; ) (n = r), (r = Si(t, r)), (r = Li(t, r)), (r = Ft(t, r));
    return (r = Mi(t, r)), (r = Ut(t, r)), r !== !1 && Wt(t, r);
  }
  var zt = zc;
    ...
    let o = t.map(({ node: g, isLast: x, index: h }) => {
        ...
        if (!x && g.type === "value-comma_group" && ee(g.groups)) {
          ...
          !w.source && w.close && (w = w.close),
            w.source && zt(e.originalText, R(w)) && m.push(_);
        }
        return m;
      }, "groups"),
      a = ki(r, s),
  ...
  function Gc(t, e, n) {
    ...
    return (
      t.each(() => {
        ...
        let { next: o } = t;
        (o.type === "css-comment" &&
          !Wt(e.originalText, P(o), { backwards: !0 }) &&
          !Te(s)) ||
        (o.type === "css-atrule" &&
          o.name === "else" &&
          s.type !== "css-comment")
          ...
          : (r.push(e.__isHTMLStyleAttribute ? A : _),
            zt(e.originalText, R(s)) && !Te(s) && r.push(_));
      }, "nodes"),
      r
    );
  }
  ...
  function Kc(t, e, n) {
    ...
    switch (r.type) {
        ...
        return (
          ...
          [
            ...
            r.nodes
              ...
              ? ""
              : e.__isHTMLStyleAttribute && Pt(t, r)
              ? Nt(";")
              : ";",
          ]
        );
      ...
      case "media-url":
        return W(
          T(!1, T(!1, r.value, /^url\(\s+/gi, "url("), /\s+\)$/g, ")"),
          e,
        );
      case "media-unknown":
        return r.value;
      ...
      case "value-string":
        return Ct(r.raws.quote + r.value + r.raws.quote, e);
      case "value-atword":
        return ["@", r.value];
  ...
  function El(t, e) {
    if (t && typeof t == "object")
      for (let n in t)
        n !== "parent" &&
          (El(t[n], e),
          n === "nodes" && ((t.group = Zr(bg(t, e))), delete t[n]));
    return t;
  }
  function kg(t, e) {
