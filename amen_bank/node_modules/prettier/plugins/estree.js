(function (f) {
  ...
  var la = (e, t, r) => (
    ...
    ma = (e) => Ss(or({}, "__esModule", { value: !0 }), e);
  var Bs = (e, t, r) => {
...
`,
  ...
  var Dl = {};
  pr(Dl, { languages: () => yl, options: () => sa, printers: () => ml });
  var gs = {};
  pr(gs, {
    canAttachComment: () => Wo,
    embed: () => Ni,
  ...
  var Ke = "string",
    ...
    be = "label",
    Pe = "break-parent",
    cr = new Set([ze, Me, Re, Qe, ue, ye, Fe, Je, Ne, Ue, ie, be, Pe]);
  function Da(e) {
    if (typeof e == "string") return Ke;
    if (Array.isArray(e)) return je;
    if (!e) return;
    let { type: t } = e;
    if (cr.has(t)) return t;
  }
  var Ze = Da;
  var fa = (e) =>
...
Expected it to be ${n}.`;
  ...
  function mt(e, t) {
    return (
      Ge(e), { type: Je, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function hn(e) {
...
` ||
  ...
  var Cr = Xa;
  function Xt(e, t) {
    return t(e) || Us(e, { getVisitorKeys: Er, predicate: t });
  }
  function Lt(e) {
    return (
  ...
  var $t = j([
    ...
    Z = j(["ObjectExpression", "RecordExpression"]);
  function ge(e) {
    return (
  ...
  function Ct(e, t) {
    ...
    if (e.arguments.length === 1) {
      ...
      (e.arguments[0].type === "TemplateLiteral" || ee(e.arguments[0])) &&
      za(e.callee)
    )
      return e.arguments[2] && !ge(e.arguments[2])
        ? !1
...
`),
    ...
    if (it(e)) {
      if (e.type === "ImportExpression" || xe(e.callee, t)) {
        let n = he(e);
  ...
  function Mn(e, t) {
    ...
    if (
      (t < 0 && (t = e.arguments.length + t), t < 0 || t >= e.arguments.length)
    )
      throw new RangeError("Invalid argument index");
    return ["arguments", t];
  }
  ...
  function Rn(e, t) {
    ...
    if (r.type === "ObjectExpression") {
      let c =
        (o = e.findAncestor((f) => f.type === "ArrowFunctionExpression")) ==
        null
          ? void 0
          : o.body;
      if (
      ...
      case "TypeAnnotation":
        if (
          e.match(
            ...
            void 0,
            (c, f) =>
              f === "returnType" && c.type === "ArrowFunctionExpression",
          ) &&
          ro(r)
        )
          return !0;
      ...
      case "FunctionTypeAnnotation": {
        if (
          e.match(
            ...
            (f, l) =>
              l === "returnType" && f.type === "ArrowFunctionExpression",
          ) ||
          e.match(
            void 0,
  ...
  function po(e, t, r) {
    ...
    return !o || (r != null && r.hasLineSuffix)
      ? { doc: [hn([" ", s]), Ae], isBlock: o, hasLineSuffix: !0 }
  ...
  var cu = qn;
  var Kn = {};
  pr(Kn, { endOfLine: () => Fo, ownLine: () => Eo, remaining: () => Co });
  function lo(e, t) {
    let r = null,
      n = t;
    for (; n !== r; )
...
`
  ...
  function ko({ comment: e, enclosingNode: t, text: r }) {
    return $e(r, O(e)) !== ")"
      ? !1
      : t && ((du(t) && X(t).length === 0) || (it(t) && he(t).length === 0))
      ? (_e(t, e), !0)
...
`);
  ...
  function Tu(e, t) {
    ...
    if (ae(r)) return Au(r) ? Go(r) : ["/*", Te(r.value), "*/"];
...
\r	`),
  ...
  function $o(e, t, r) {
    ...
    let s =
        n.type === "JSXElement" ? r("openingElement") : r("openingFragment"),
    ...
    let i = n.children.some(Y),
      a =
        n.children.filter((T) => T.type === "JSXExpressionContainer").length >
        1,
      ...
      e.each(({ node: i, next: a }) => {
        if (i.type === "JSXText") {
          ...
          if (Zt(i)) {
            ...
            let m;
            if (
              (w(!1, p, -1) === "" && (p.pop(), (m = p.pop())), p.length === 0)
            )
              return;
  ...
  function zo(e, t, r) {
    ...
    if ((s.push(r("name")), n.value)) {
      ...
      if (ee(n.value)) {
        ...
        (a = o === '"' ? H(!1, a, '"', "&quot;") : H(!1, a, "'", "&apos;")),
          (u = e.call(() => pe(e, Te(o + a + o), t), "value"));
      } else u = r("value");
      s.push("=", u);
    }
    return s;
...
`),
  ...
  function Zt(e) {
    return (
      e.type === "JSXText" &&
      (kr.hasNonWhitespaceCharacter(oe(e)) || !/\n/.test(oe(e)))
    );
  }
  function op(e) {
    return (
  ...
  function Zn(e, t, r, n, s) {
    ...
    if ((i.push(o ? "" : " ", l ? y(D, { shouldBreak: f }) : D), n && d(u))) {
      let g = Bt(pe(e, i, r));
      return Array.isArray(g) || g.type === ye ? yr(g) : [g];
    }
    return i;
  }
  function Ot(e) {
    return e.type !== "LogicalExpression"
      ? !1
      : !!(
          (Z(e.right) && e.right.properties.length > 0) ||
  ...
  function vt(e, t, r) {
    ...
    if (o.length === 0) s.push(mp(e, t, u, i));
      ...
      s.push(
        y(
          [u, E([F, l ? Dp(e, t, r, h) : [yp(e, t, a, r), h], M(e, t)]), F, i],
          { shouldBreak: f, id: c },
        ),
      );
    }
  ...
  function fp(e, t, r) {
    ...
    let D = ["(", E([F, ...a]), P(p), F, ")"];
    return Sr(e) ? D : y(D, { shouldBreak: a.some(K) || u });
  }
  function er(e, t = !1) {
    return (
      (Z(e) && (e.properties.length > 0 || d(e))) ||
  ...
  function Pu(e) {
    ...
    if (Le(e) || e.type === "TypeCastExpression") {
      ...
      return (
        ...
        r.type === "TSArrayType" &&
          ((r = r.elementType),
          r.type === "TSArrayType" && (r = r.elementType)),
        ...
        wt(r) && xe(e.expression, 1)
      );
    }
    return it(e) && he(e).length > 1
      ? !1
      : ce(e)
      ? xe(e.left, 1) && xe(e.right, 1)
      : wn(e) || xe(e);
  }
  function Cp(e) {
    return (
  ...
  function Tp(e, t, r) {
    ...
    function a(L) {
      ...
      k(W) && (Dt(W.callee) || k(W.callee))
        ...
        ? (u.unshift({
            node: W,
            needsParens: we(L, t),
            printed: pe(L, J(W) ? ts(L, t, r) : wr(L, t, r), t),
          }),
    ...
    for (
      ...
      (u[D].node.type === "TSNonNullExpression" ||
        k(u[D].node) ||
        (J(u[D].node) && u[D].node.computed && ge(u[D].node.property)));
      ++D
    )
      m.push(u[D]);
    if (!k(u[0].node))
    ...
    for (; D < u.length; ++D) {
      if (c && Dt(u[D].node)) {
        if (u[D].node.computed && ge(u[D].node.property)) {
          m.push(u[D]);
          continue;
        }
        p.push(m), (m = []), (c = !1);
    ...
    function h(L) {
      var Tn;
      let W = (Tn = L[1][0]) == null ? void 0 : Tn.node.computed;
      if (L[0].length === 1) {
        let ar = L[0][0].node;
        return (
    ...
    if (p.length <= R && !N) return Sr(e) ? _ : y(_);
    ...
    function dn() {
      let L = w(!1, w(!1, p, -1), -1).node,
        W = w(!1, v, -1);
      return (
        k(L) && K(W) && Ee.slice(0, -1).some((se) => se.arguments.some(It))
      );
    }
    let An;
    return (
      N ||
      (Ee.length > 2 && Ee.some((L) => !L.arguments.every((W) => xe(W)))) ||
      v.slice(0, -1).some(K) ||
      dn()
        ? (An = y(Be))
        : (An = [K(_) || V ? Ae : "", qe([_, Be])]),
  ...
  function Or(e, t, r) {
    ...
    let { node: n, parent: s } = e,
      ...
      a = $(e),
      o = he(n),
      p = o.length === 1 && gr(o[0], t.originalText);
  ...
  function xp(e, t) {
    ...
    if (e.callee.name === "require") return !0;
    if (e.callee.name === "define") {
      ...
      return (
        ...
        (r.length === 1 ||
          ...
          (r.length === 3 && ee(r[0]) && r[1].type === "ArrayExpression"))
      );
    }
    return !1;
  }
  ...
  function vu(e, t) {
    ...
    switch (r.type) {
      case "RegExpLiteral":
        return wu(r);
      case "BigIntLiteral":
        return vr(r.extra.raw);
      case "NumericLiteral":
        return He(r.extra.raw);
      case "StringLiteral":
        return Te(Tt(r.extra.raw, t));
      case "NullLiteral":
        return "null";
      case "BooleanLiteral":
  ...
  function ft(e, t, r, n, s, u) {
    ...
    switch (i) {
      ...
      case "fluid": {
        ...
        return y([y(n), s, y(E(A), { id: o }), de, mt(a, { groupId: o })]);
      }
      case "break-lhs":
        return y([n, s, " ", y(a)]);
      case "chain":
    ...
    if (
      ...
      return a
        ? i.type === "ArrowFunctionExpression" &&
          ...
          : "chain-tail"
        : "chain";
    if ((!a && jr(i.right)) || Ie(t.originalText, i))
  ...
  function Ru(e) {
    return jr(e) || e.type === "VariableDeclarator";
  }
  function Ip(e) {
    let t = wp(e);
    if (b(t)) {
  ...
  function Ju(e, t, r, n = !1) {
    ...
    if (k(s)) {
      if ((i = Or(e, t, r).label) != null && i.memberChain) return !1;
      let o = he(s);
...
`)
      ...
      (r.type === "ObjectPattern" ||
        ...
        (r.type === "AssignmentPattern" &&
          ...
          (r.right.type === "Identifier" ||
            (Z(r.right) && r.right.properties.length === 0) ||
  ...
  function Uu(e, t, r) {
    let n = t.semi ? ";" : "",
      { node: s } = e,
      u = [Q(e), "opaque type ", r("id"), r("typeParameters")];
    return (
  ...
  function zr(e, t, r) {
    let { node: n } = e,
      s = [qu(e, t, r), Q(e), "export", Vu(n) ? " default" : ""],
      { declaration: u, exported: i } = n;
    return (
      d(n, x.Dangling) && (s.push(" ", M(e, t)), hr(n) && s.push(C)),
      u
  ...
  function zp(e, t, r) {
    let { node: n } = e,
      ...
      a = s
        ? r("test")
        : [r("checkType"), " ", "extends", " ", r("extendsType")];
  ...
  function Mt(e, t, r) {
    ...
    let _ = [u, i, ...a].some((V) =>
      ...
      R = (V) => (c === I ? y(V, { shouldBreak: _ }) : _ ? [V, Ae] : V),
      T =
        !D &&
...
`,
        ...
        case ue:
          switch (f) {
            case nt:
              if (!o) {
                i.push({ ind: c, mode: l.break ? Ce : nt, doc: l.contents });
                break;
              }
            case Ce: {
              o = !1;
              let h = { ind: c, mode: nt, doc: l.contents },
                g = n - u,
                S = p.length > 0;
              if (!l.break && Qr(h, i, g, S, r)) i.push(h);
              else if (l.expandedStates) {
                let I = w(!1, l.expandedStates, -1);
                if (l.break) {
                  i.push({ ind: c, mode: Ce, doc: I });
                  break;
                } else
              ...
              } else i.push({ ind: c, mode: Ce, doc: l.contents });
              break;
            }
          }
        ...
        case ye: {
          ...
          let [S, I] = g,
            ...
            _ = { ind: c, mode: Ce, doc: S },
            R = Qr(v, [], h, p.length > 0, r, !0);
          if (g.length === 1) {
            R ? i.push(v) : i.push(_);
            break;
          }
          let T = { ind: c, mode: nt, doc: I },
            N = { ind: c, mode: Ce, doc: I };
          if (g.length === 2) {
          ...
          let Se = { ind: c, mode: f, doc: St(g) },
            V = g[0];
          Qr({ ind: c, mode: nt, doc: [S, I, V] }, [], h, p.length > 0, r, !0)
            ? i.push(Se, T, v)
            : R
            ? i.push(Se, N, v)
            : i.push(Se, N, _);
...
`) && o.push({ hasLineBreak: !1, cells: [] });
  ...
  function ct(e, t, r) {
    ...
    let { parent: s } = e,
      { key: u } = n;
    if (t.quoteProps === "consistent" && !sn.has(s)) {
      let i = (s.properties || s.body || s.members).some(
        (a) => !a.computed && a.key && ee(a.key) && !_n(a, t),
      );
      sn.set(s, i);
    }
    if (
      ...
      (t.parser === "json" || (t.quoteProps === "consistent" && sn.get(s)))
    ) {
      let i = Tt(
    ...
    return _n(n, t) &&
      (t.quoteProps === "as-needed" ||
        (t.quoteProps === "consistent" && !sn.get(s)))
      ? e.call(
  ...
  function sr(e, t, r) {
    ...
    return (
      !s || s === "init" || s === "method" || s === "constructor"
        ...
        : (nn.ok(s === "get" || s === "set"), i.push(s, " ")),
      u.generator && i.push("*"),
      i.push(
        ct(e, t, r),
        n.optional || n.key.optional ? "?" : "",
        n === u ? an(e, t, r) : r("value"),
      ),
      i
    );
  }
  ...
  function Et(e, t, r) {
    ...
    if (s.inexact || s.hasUnknownMembers) {
      ...
      if (d(s, x.Dangling)) {
        ...
        T = [
          M(e, t),
          N || z(t.originalText, O(w(!1, Kt(s), -1))) ? C : A,
          "...",
        ];
      } else T = ["..."];
      S.push([...g, ...T]);
  ...
  function Cc(e, t, r, n) {
    let { node: s } = e,
      u = [];
    if ((s.async && u.push("async "), on(e, t))) u.push(r(["params", 0]));
    else {
  ...
  function dc(e, t, r) {
    ...
    return (
      ...
      (((n = t.label) == null ? void 0 : n.hug) !== !1 &&
        (((s = t.label) == null ? void 0 : s.embed) || gr(e, r.originalText)))
    );
  }
  ...
  function Ai(e, t) {
    ...
    return we(e, t) ? !0 : Lt(r) ? e.call(() => Ai(e, t), ...Ar(r)) : !1;
  }
  ...
  function gi(e, t, r, n) {
    ...
    switch (s.type) {
      ...
      case "ChainExpression":
        return r("expression");
      case "ParenthesizedExpression":
        return !d(s.expression) && (Z(s.expression) || G(s.expression))
          ? ["(", r("expression"), ")"]
      ...
      case "BindExpression":
        return (
          s.object && i.push(r("object")), i.push(y(E([F, wr(e, t, r)]))), i
        );
      case "Identifier":
        return [s.name, $(e), Hr(e), q(e, r)];
        ...
        if ((i.push("await"), s.argument)) {
          ...
          if ((k(a) && a.callee === s) || (J(a) && a.object === s)) {
            ...
            let o = e.findAncestor(
              (p) =>
                p.type === "AwaitExpression" || p.type === "BlockStatement",
            );
            if (
      ...
      case "IfStatement": {
        ...
        if ((i.push(o), s.alternate)) {
          let p = d(s.consequent, x.Trailing | x.Line) || hr(s),
        ...
        return !s.init && !s.test && !s.update
          ...
          : [
              ...
              y([
                "for (",
                y([
                  E([F, r("init"), ";", A, r("test"), ";", A, r("update")]),
                  F,
                ]),
                ")",
                a,
  ...
  function Pi(e, t, r) {
    let { node: n } = e;
    if (Fr(n)) return n.type.slice(0, -14).toLowerCase();
    let s = t.semi ? ";" : "";
    switch (n.type) {
      case "DeclareClass":
        return cn(e, t, r);
      case "DeclareFunction":
        return [Q(e), "function ", r("id"), r("predicate"), s];
      case "DeclareModule":
        return ["declare module ", r("id"), " ", r("body")];
      case "DeclareModuleExports":
        return ["declare module.exports", q(e, r), s];
      case "DeclareVariable":
        return [Q(e), n.kind ?? "var", " ", r("id"), s];
      ...
      case "Variance": {
        let { kind: u } = n;
        return nn.ok(u === "plus" || u === "minus"), u === "plus" ? "+" : "-";
      }
  ...
  function ki(e, t, r) {
    ...
    if (Cr(n)) return n.type.slice(2, -7).toLowerCase();
    let s = t.semi ? ";" : "",
      u = [];
    switch (n.type) {
      case "TSThisType":
        return "this";
      case "TSTypeAssertion": {
        let a = !(G(n.expression) || Z(n.expression)),
      ...
      case "TSModuleDeclaration": {
        let { parent: a } = e,
          ...
          p =
            ((i = n.body) == null ? void 0 : i.type) === "TSModuleDeclaration";
        if (o) u.push(".");
        else if ((u.push(Q(e)), !(n.kind === "global" || n.global))) {
          let D =
            n.kind ??
            (ee(n.id) ||
...
`),
  ...
  async function Gc(e, t, r) {
    ...
    let a = en(await e(s, { parser: "markdown", __inJsTemplate: !0 }), !0);
    return ["`", i ? E([F, a]) : [mr, ws(a)], F, "`"];
  }
  function qc(e) {
    let t = e.match(/^([^\S\n]*)\S/m);
    return t === null ? "" : t[1];
  ...
  function Ui(e, t, r) {
    ...
    if (
      ...
      (e.type === "BigIntLiteral" ||
        e.type === "BigIntLiteralTypeAnnotation") &&
        t.value &&
    ...
    if (
      ...
      e.type === "TemplateLiteral" &&
        (((u = e.leadingComments) != null &&
          u.some(
            (a) =>
              ae(a) && ["GraphQL", "HTML"].some((o) => a.value === ` ${o} `),
          )) ||
