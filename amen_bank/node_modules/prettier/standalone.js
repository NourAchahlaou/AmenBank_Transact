(function (t) {
  ...
  var Ce = (t, e, r) => (
    ...
    nr = (t) => rr($e({}, "__esModule", { value: !0 }), t);
  var du = (t, e, r) => {
          ...
          for (var p = -1 * D; p <= D; p += 2) {
            ...
            if (
              (!C || (_ && E.newPos < h.newPos)
                ? ((m = Eu(h)), u.pushComponent(m.components, void 0, !0))
                : ((m = E),
                  m.newPos++,
              ...
              return i(mu(u, m.components, r, e, u.useLongestToken));
            F[p] = m;
          }
          D++;
        }
  ...
  var ln = {};
  Me(ln, { default: () => eo, shouldHighlight: () => Qu });
  var Qu,
    eo,
    fn = pu(() => {
      (Qu = () => !1), (eo = String);
  ...
  var hn = Ue((pt) => {
    ...
    function En(t, e, r = {}) {
      let n = (r.highlightCode || r.forceColor) && (0, pn.shouldHighlight)(r),
        ...
        i = (p, m) => (n ? p(m) : m),
        s = t.split(mn),
        { start: a, end: D, markerLines: c } = uo(e, s, r),
...
`,
        ...
        case M:
          ...
          break;
        case T:
          i.push({ ind: vu(f, e), mode: d, doc: l.contents });
          break;
        case S:
          i.push({ ind: Pu(f, l.n, e), mode: d, doc: l.contents });
          break;
        case v:
          u -= kt(s);
          break;
        ...
        case k: {
          ...
          let Q = { ind: f, mode: d, doc: Ge(m) },
            tr = m[0];
          Qe({ ind: f, mode: K, doc: [E, h, tr] }, [], p, D.length > 0, r, !0)
            ? i.push(Q, Z, g)
            : _
            ? i.push(Q, $, g)
            : i.push(Q, $, C);
  ...
  function Sr(t) {
    ...
    function n(u, i, s) {
      ...
      if (u.type === b)
        return ((D = s == null ? void 0 : s[i - 1]) == null
          ? void 0
          : D.type) === x && s[i - 1].hard
          ? void 0
          : "breakParent";
...
in order for it to be formatted.`,
  ...
  function et({ plugins: t = [], showDeprecated: e = !1 } = {}) {
    let r = t.flatMap((o) => o.languages ?? []),
      n = [];
    for (let o of Ru(Object.assign({}, ...t.map(({ options: u }) => u), vr)))
      (!e && o.deprecated) ||
        (Array.isArray(o.choices) &&
          (e || (o.choices = o.choices.filter((u) => !u.deprecated)),
          o.name === "parser" &&
            (o.choices = [...o.choices, ...Iu(o.choices, r, t)])),
...
`,
    ...
    _applyNormalization(e, r) {
      ...
      for (let i of o) {
        ...
        if ((f.redirect.forEach(D), "remain" in f)) {
          let d = f.remain;
          (r[i] = i in r ? s.overlap(r[i], d, this._utils) : d),
            c({ value: d });
        }
  ...
  function Ku(t, { isCLI: e, FlagSchema: r }) {
    ...
    for (let o of t)
      n.push(Hu(o, { isCLI: e, optionInfos: t, FlagSchema: r })),
        o.alias &&
          e &&
          n.push(nt.create({ name: o.alias, sourceName: o.name }));
    return n;
  }
...
`
  ...
  var er = {};
  Me(er, { builders: () => Ko, printer: () => Ho, utils: () => qo });
  var Ko = {
      join: ke,
      line: Ke,
      softline: Er,
